...
public class F extends J implements Listener
{
    ...
    public void apply(final Player player) {
        ...
        if (playerArmorSnapshot != null) {
            if (playerArmorSnapshot.C() != null) {
                this.E(playerArmorSnapshot.C(), customHead);
            }
            if (playerArmorSnapshot.E() != null) {
                this.E(playerArmorSnapshot.E(), coloredArmor);
            }
            if (playerArmorSnapshot.B() != null) {
                this.E(playerArmorSnapshot.B(), coloredArmor2);
            }
            if (playerArmorSnapshot.A() != null) {
                this.E(playerArmorSnapshot.A(), coloredArmor3);
            }
        }
        this.E(customHead, "helmet");
        this.E(coloredArmor, "chestplate");
        this.E(coloredArmor2, "leggings");
        this.E(coloredArmor3, "boots");
    ...
    private void E(final ItemStack itemStack, final String s) {
        if (itemStack == null) {
            return;
        }
    ...
    private void E(final ItemStack itemStack, final ItemStack itemStack2) {
    ...
    public void remove(final Player player) {
        ...
        F.playerArmorMap.remove(player.getUniqueId());
    }
    ...
    public void showOriginalArmor(final Player player) {
        ...
        final I i = F.playerArmorMap.get(player.getUniqueId());
        if (i == null) {
            return;
        }
        if (i.C() != null) {
    ...
    public void applyEffects(final Player player) {
        F.\u015c.put(player.getUniqueId(), true);
    }
    
    public void removeEffects(final Player player) {
        F.\u015c.remove(player.getUniqueId());
    }
    ...
    public void onPlayerDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (entityDamageByEntityEvent.getDamager() instanceof Player && entityDamageByEntityEvent.getEntity() instanceof Player && F.\u015c.containsKey(((Player)entityDamageByEntityEvent.getDamager()).getUniqueId())) {
    ...
    public void onPlayerTakeDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (entityDamageByEntityEvent.getEntity() instanceof Player && F.\u015c.containsKey(((Player)entityDamageByEntityEvent.getEntity()).getUniqueId())) {
    ...
    public void onPlayerKill(final PlayerDeathEvent playerDeathEvent) {
        ...
        if (killer != null && F.\u015c.containsKey(killer.getUniqueId()) && this.\u014e && Main.getInstance().getServer().getPluginManager().getPlugin("Vault") != null) {
            try {
