...
import pl.ziffy.STORMSZAFKA.costumes.CostumesItemsListener6;
...
public class CostumesItemsListener5 extends J implements Listener
{
    ...
    public CostumesItemsListener5() {
        ...
        this.P();
        if (this.plugin != null && !CostumesItemsListener5.\u0132) {
            Bukkit.getPluginManager().registerEvents((Listener)this, this.plugin);
            CostumesItemsListener5.\u0132 = true;
        }
    }
            ...
            Files.write(this.\u013d.toPath(), """
                                              ...
                                              effects:
                                                ...
                                                double_jump:
                                                  enabled: true
                                                  cooldown: 15000
                                                # CostumesItemsListener4\u017awi\u0119ki / Sounds
                                                sounds:
    ...
    private void CostumesItemsListener1(final Player player, final String s) {
    ...
    public void apply(final Player player) {
        ...
        final I i = CostumesItemsListener5.playerArmorMap.get(player.getUniqueId());
        this.CostumesItemsListener1(player, i);
        ...
        if (i.CostumesItemsListener3() != null) {
            this.copyEnchantments(i.CostumesItemsListener3(), customHead);
            this.copyCustomEnchantsToLore(i.CostumesItemsListener3(), customHead);
        }
        if (i.CostumesItemsListener5() != null) {
            this.copyEnchantments(i.CostumesItemsListener5(), coloredArmor);
            this.copyCustomEnchantsToLore(i.CostumesItemsListener5(), coloredArmor);
        }
        if (i.CostumesItemsListener2() != null) {
            this.copyEnchantments(i.CostumesItemsListener2(), coloredArmor2);
            this.copyCustomEnchantsToLore(i.CostumesItemsListener2(), coloredArmor2);
        }
        if (i.CostumesItemsListener1() != null) {
            this.copyEnchantments(i.CostumesItemsListener1(), coloredArmor3);
            this.copyCustomEnchantsToLore(i.CostumesItemsListener1(), coloredArmor3);
        }
        this.CostumesItemsListener4(customHead, "");
        this.CostumesItemsListener4(coloredArmor, "");
        this.CostumesItemsListener4(coloredArmor2, "");
        this.CostumesItemsListener4(coloredArmor3, "");
    ...
    private void CostumesItemsListener1(final Player player, final I i) {
        if (i == null) {
            return;
        }
        final ItemStack c = i.CostumesItemsListener3();
    ...
    private void CostumesItemsListener5(final Player player) {
        if (player.getGameMode() != GameMode.SURVIVAL && player.getGameMode() != GameMode.ADVENTURE) {
            return;
        }
        player.setAllowFlight(true);
        if (player.isOnGround() && !this.CostumesItemsListener4(player)) {
            CostumesItemsListener5.\u013b.put(player.getUniqueId(), false);
    ...
    private void CostumesItemsListener1(final ItemStack itemStack, final String s, final boolean b) {
        if (itemStack == null) {
            return;
        }
    ...
    private void CostumesItemsListener3(final ItemStack itemStack, final String s) {
        this.CostumesItemsListener1(itemStack, s, true);
    }
    
    private void CostumesItemsListener4(final ItemStack itemStack, final String s) {
        if (itemStack == null) {
            return;
        }
        final ItemMeta itemMeta = itemStack.getItemMeta();
    ...
    public void remove(final Player player) {
        ...
        CostumesItemsListener5.playerArmorMap.remove(player.getUniqueId());
        CostumesItemsListener5.\u013b.remove(player.getUniqueId());
        CostumesItemsListener5.doubleJumpCooldowns.remove(player.getUniqueId());
        CostumesItemsListener5.\u0120.remove(player.getUniqueId());
    }
    ...
    private boolean CostumesItemsListener2(final ItemStack itemStack) {
        if (itemStack == null) {
            return false;
        }
    ...
    private boolean CostumesItemsListener4(final ItemStack itemStack, final ItemStack itemStack2) {
    ...
    public void applyEffects(final Player player) {
        ...
        if (potionEffect != null) {
            CostumesItemsListener5.\u0120.put(player.getUniqueId(), potionEffect);
            if (this.\u012c) {}
        }
        else {
            CostumesItemsListener5.\u0120.remove(player.getUniqueId());
        ...
        if (this.\u0129) {
            this.CostumesItemsListener5(player);
            if (this.\u012c) {}
        }
    }
    ...
    public void removeEffects(final Player player) {
        player.removePotionEffect(PotionEffectType.FAST_DIGGING);
        final PotionEffect potionEffect = CostumesItemsListener5.\u0120.get(player.getUniqueId());
        if (potionEffect != null) {
    ...
    private void CostumesItemsListener3(final ItemStack itemStack) {
        if (itemStack == null) {
            return;
        }
        final ItemMeta itemMeta = itemStack.getItemMeta();
    ...
    public void onFallDamage(final EntityDamageEvent entityDamageEvent) {
        ...
        if (L.CostumesItemsListener6(player) && L.CostumesItemsListener1(player) instanceof CostumesItemsListener5 && entityDamageEvent.getCause() == EntityDamageEvent.DamageCause.FALL && this.\u0111) {
    ...
    public void onTotemUse(final EntityResurrectEvent entityResurrectEvent) {
        ...
        if (!entityResurrectEvent.isCancelled() && "zabojczykrolik".equals(L.CostumesItemsListener4(player)) && this.\u0110) {
    ...
    public void onPlayerMove(final PlayerMoveEvent playerMoveEvent) {
        ...
        if (!L.CostumesItemsListener6(player) || !(L.CostumesItemsListener1(player) instanceof CostumesItemsListener5) || !this.\u0129) {
            return;
        }
        if (player.getGameMode() != GameMode.SURVIVAL && player.getGameMode() != GameMode.ADVENTURE) {
            return;
        }
        if (this.CostumesItemsListener4(player)) {
            return;
        }
    ...
    public void onPlayerToggleFlight(final PlayerToggleFlightEvent playerToggleFlightEvent) {
        ...
        final Boolean b = CostumesItemsListener5.\u013b.get(player.getUniqueId());
        if (b != null && !b) {
            playerToggleFlightEvent.setCancelled(true);
            CostumesItemsListener5.\u013b.put(player.getUniqueId(), true);
            ...
            if (this.\u011a != null && !this.\u011a.isEmpty()) {
                ...
                if (languageManager != null) {
                    final String f = languageManager.CostumesItemsListener6("costume.zabojczy-krolik.double-jump-used");
            ...
            this.CostumesItemsListener6(player);
        }
    }
    
    private boolean CostumesItemsListener4(final Player player) {
        if (player == null) {
            return false;
        }
        final Long n = CostumesItemsListener5.doubleJumpCooldowns.get(player.getUniqueId());
        return n != null && System.currentTimeMillis() - n < this.\u010c;
    }
    
    private long CostumesItemsListener3(final Player player) {
        if (player == null) {
            return 0L;
        }
        final Long n = CostumesItemsListener5.doubleJumpCooldowns.get(player.getUniqueId());
    ...
    private void CostumesItemsListener6(final Player player) {
        if (player == null) {
            return;
        }
        CostumesItemsListener5.doubleJumpCooldowns.put(player.getUniqueId(), System.currentTimeMillis());
        new BukkitRunnable() {
            public void run() {
                if (player.isOnline() && !CostumesItemsListener5.this.CostumesItemsListener4(player) && L.CostumesItemsListener6(player) && L.CostumesItemsListener1(player) instanceof CostumesItemsListener5) {
                    player.setAllowFlight(true);
    ...
    private void CostumesItemsListener7(final Player player) {
        final Main instance = Main.getInstance();
        if (instance != null) {
            final pl.ziffy.STORMSZAFKA.data.CostumesItemsListener5 costumeDataManager = instance.getCostumeDataManager();
            if (costumeDataManager != null) {
                costumeDataManager.CostumesItemsListener2(player);
            }
        }
    }
    ...
    protected void copyEnchantments(final ItemStack itemStack, final ItemStack itemStack2) {
        ...
        if (itemStack.hasItemMeta()) {
            ...
            this.CostumesItemsListener1(itemStack, itemStack2, itemMeta, itemMeta2);
    ...
    private void CostumesItemsListener1(final ItemStack itemStack, final ItemStack itemStack2, final ItemMeta itemMeta, final ItemMeta itemMeta2) {
        try {
            if (itemMeta.hasAttributeModifiers()) {
                itemMeta2.setAttributeModifiers(itemMeta.getAttributeModifiers());
            }
            final double a = this.CostumesItemsListener1(itemStack.getType());
            final double b = this.CostumesItemsListener2(itemStack.getType());
            if (a > 0.0) {
                itemMeta2.addAttributeModifier(Attribute.GENERIC_ARMOR, new AttributeModifier(UUID.randomUUID(), "costume_armor", a, AttributeModifier.Operation.ADD_NUMBER, this.CostumesItemsListener4(itemStack2.getType())));
            }
            if (b > 0.0) {
                itemMeta2.addAttributeModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, new AttributeModifier(UUID.randomUUID(), "costume_toughness", b, AttributeModifier.Operation.ADD_NUMBER, this.CostumesItemsListener4(itemStack2.getType())));
            }
            final double c = this.CostumesItemsListener3(itemStack.getType());
            if (c > 0.0) {
                itemMeta2.addAttributeModifier(Attribute.GENERIC_KNOCKBACK_RESISTANCE, new AttributeModifier(UUID.randomUUID(), "costume_knockback_resistance", c, AttributeModifier.Operation.ADD_NUMBER, this.CostumesItemsListener4(itemStack2.getType())));
            }
        }
        catch (final Exception ex) {}
    }
    
    private double CostumesItemsListener1(final Material material) {
        switch (CostumesItemsListener5$2.CostumesItemsListener1[material.ordinal()]) {
            case 1: {
                return 1.0;
            }
            case 2: {
    ...
    private double CostumesItemsListener2(final Material material) {
        switch (CostumesItemsListener5$2.CostumesItemsListener1[material.ordinal()]) {
            case 17:
            case 18:
            case 19:
    ...
    private double CostumesItemsListener3(final Material material) {
        switch (CostumesItemsListener5$2.CostumesItemsListener1[material.ordinal()]) {
            case 21:
            case 22:
            case 23:
    ...
    private EquipmentSlot CostumesItemsListener4(final Material material) {
    ...
    static {
        ...
        CostumesItemsListener5.\u0132 = false;
    }
}
