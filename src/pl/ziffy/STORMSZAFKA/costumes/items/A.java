...
public class A extends J implements Listener
{
    ...
    private void b() {
        try {
            ...
            Files.write(this.\u01c9.toPath(), """
                                              ...
                                              # D\u017awi\u0119ki kostiumu
                                              sounds:
                                                # D\u017awi\u0119k za\u0142o\u017cenia kostiumu
                                                equip:
                                                  sound: "ENTITY_EXPERIENCE_ORB_PICKUP"
                                                  volume: 1.0
                                                  pitch: 1.2
                                                
                                                # D\u017awi\u0119k specjalnych efekt\u00f3w
                                                effect:
    ...
    private void d() {
        try {
            ...
            this.\u01b4 = this.B(this.\u01bf.getConfigurationSection("activation_item.leather_color"));
            ...
            if (configurationSection != null) {
                ...
                if (configurationSection2 != null) {
                    ...
                    this.\u01b2 = this.B(this.\u01bf.getConfigurationSection("armor.colors.chestplate"));
                    this.\u01c1 = this.B(this.\u01bf.getConfigurationSection("armor.colors.leggings"));
                    this.\u01ac = this.B(this.\u01bf.getConfigurationSection("armor.colors.boots"));
                }
    ...
    private Color B(final ConfigurationSection configurationSection) {
        if (configurationSection == null) {
    ...
    public void apply(final Player player) {
        ...
        if (playerArmorSnapshot != null) {
            if (playerArmorSnapshot.C() != null) {
                this.I(playerArmorSnapshot.C(), customHead);
            }
            if (playerArmorSnapshot.E() != null) {
                this.I(playerArmorSnapshot.E(), coloredArmor);
            }
            if (playerArmorSnapshot.B() != null) {
                this.I(playerArmorSnapshot.B(), coloredArmor2);
            }
            if (playerArmorSnapshot.A() != null) {
                this.I(playerArmorSnapshot.A(), coloredArmor3);
            }
        }
        this.B(customHead, "helmet", true);
        this.B(coloredArmor, "chestplate", true);
        this.B(coloredArmor2, "leggings", true);
        this.B(coloredArmor3, "boots", true);
    ...
    private void B(final ItemStack itemStack, final String s, final boolean b) {
        if (itemStack == null) {
            return;
        }
    ...
    public void remove(final Player player) {
        ...
        A.playerArmorMap.remove(player.getUniqueId());
        A.\u01a8.remove(player.getUniqueId());
    }
    ...
    public ItemStack getPreviewCostumeItem() {
        ...
        if (itemMeta != null) {
            ...
            final ArrayList lore = new ArrayList((Collection<? extends E>)this.\u01c7);
            lore.removeIf(s2 -> {
    ...
    private boolean H(final ItemStack itemStack, final ItemStack itemStack2) {
    ...
    public void applyEffects(final Player player) {
        A.\u01a8.put(player.getUniqueId(), true);
        ...
        if (attribute != null) {
            for (final AttributeModifier attributeModifier : attribute.getModifiers()) {
                if (attributeModifier.getUniqueId().equals(A.\u01aa)) {
                    attribute.removeModifier(attributeModifier);
                    break;
                }
            }
            attribute.addModifier(new AttributeModifier(A.\u01aa, "valentine_health_bonus", this.\u01b6, AttributeModifier.Operation.ADD_NUMBER));
    ...
    public void onFallDamage(final EntityDamageEvent entityDamageEvent) {
        ...
        if (L.F(player) && L.A(player) instanceof A && this.\u01a7) {
    ...
    public void onPlayerDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (L.F(player) && L.A(player) instanceof A && this.\u01bc > 0.0) {
    ...
    public void onPlayerTakeDamage(final EntityDamageEvent entityDamageEvent) {
        ...
        final Player player = (Player)entityDamageEvent.getEntity();
        if (L.F(player) && L.A(player) instanceof A && this.\u01ba > 0.0) {
