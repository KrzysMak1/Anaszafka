...
public class H extends J implements Listener
{
    ...
    public void apply(final Player player) {
        ...
        if (playerArmorSnapshot != null) {
            if (playerArmorSnapshot.C() != null) {
                this.G(playerArmorSnapshot.C(), customHead);
            }
            if (playerArmorSnapshot.E() != null) {
                this.G(playerArmorSnapshot.E(), coloredArmor);
            }
            if (playerArmorSnapshot.B() != null) {
                this.G(playerArmorSnapshot.B(), coloredArmor2);
            }
            if (playerArmorSnapshot.A() != null) {
                this.G(playerArmorSnapshot.A(), coloredArmor3);
            }
        }
        this.G(customHead, "helmet");
        this.G(coloredArmor, "chestplate");
        this.G(coloredArmor2, "leggings");
        this.G(coloredArmor3, "boots");
    ...
    private void G(final ItemStack itemStack, final String s) {
        if (itemStack == null) {
            return;
        }
    ...
    public void remove(final Player player) {
        ...
        H.playerArmorMap.remove(player.getUniqueId());
        H.\u01a3.remove(player.getUniqueId());
    }
    ...
    public ItemStack getPreviewCostumeItem() {
        ...
        if (itemMeta != null) {
            ...
            final ArrayList lore = new ArrayList((Collection<? extends E>)this.\u0199);
            lore.removeIf(s2 -> {
    ...
    public void showOriginalArmor(final Player player) {
        ...
        if (languageManager != null) {
            final String f = languageManager.F("costume.kostium-maly-urwis.show-original");
    ...
    public void restoreCostume(final Player player) {
        ...
        final A languageManager = Main.getLanguageManager();
        if (languageManager != null) {
            final String f = languageManager.F("costume.kostium-maly-urwis.show-costume");
            if (f != null && !f.isEmpty() && !f.contains("Missing language key")) {
                player.sendMessage(f);
            }
        }
    ...
    public void applyEffects(final Player player) {
        H.\u01a3.put(player.getUniqueId(), true);
        if (this.\u0191 > 0.0) {
            ...
            if (attribute != null) {
                for (final AttributeModifier attributeModifier : new ArrayList(attribute.getModifiers())) {
                    if (attributeModifier.getUniqueId().equals(H.\u0184)) {
                        attribute.removeModifier(attributeModifier);
                        break;
                    }
                }
                attribute.addModifier(new AttributeModifier(H.\u0184, "costume_damage_bonus", this.\u0191, AttributeModifier.Operation.MULTIPLY_SCALAR_1));
            }
        }
        if (this.\u0196 && this.\u0187 > 0) {
    ...
    public void onFallDamage(final EntityDamageEvent entityDamageEvent) {
        ...
        if (!H.\u01a3.containsKey(((Player)entityDamageEvent.getEntity()).getUniqueId())) {
            return;
        }
    ...
    public void onPlayerKill(final PlayerDeathEvent playerDeathEvent) {
        ...
        if (!H.\u01a3.containsKey(killer.getUniqueId())) {
            return;
        }
        final double b = this.B(killer, entity);
        if (b > 0.0) {
            if (this.\u01a0 != null) {
            ...
            final A languageManager = Main.getLanguageManager();
            if (languageManager != null) {
                final String replace = languageManager.F("costume.kostium-maly-urwis.money-steal").replace("%amount%", String.format("%.2f", b)).replace("%player%", entity.getName());
                ...
                final String replace2 = languageManager.F("costume.kostium-maly-urwis.money-steal-target").replace("%amount%", String.format("%.2f", b)).replace("%killer%", killer.getName());
    ...
    private double B(final Player player, final Player player2) {
        try {
    ...
    private void G(final ItemStack itemStack, final ItemStack itemStack2) {
