...
public class C extends J implements Listener
{
    ...
    private void I() {
        ...
        this.\u00d4 = this.G(this.\u00ce.getString("activation_item.display_name", "&7Kostium &bnurka g\u0142\u0119binowego"));
        this.¥ = this.G(this.\u00ce.getString("activation_item.preview_display_name", "&7Kostium &bnurka g\u0142\u0119binowego"));
        this.\u00db = (List)this.\u00ce.getStringList("activation_item.lore").stream().map(this::G).collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
        ...
        this.\u00c6 = this.E(this.\u00ce.getString("activation_item.leather_color", "0,100,100"));
        this.µ = this.G(this.\u00ce.getString("armor_appearance.display_name", "&7Zbroja &bNurka G\u0142\u0119binowego"));
        this.\u00d6 = (List)this.\u00ce.getStringList("armor_appearance.base_lore").stream().map(this::G).collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
        this.\u00c1 = this.E(this.\u00ce.getString("armor_appearance.armor_colors.chestplate", "0,100,100"));
        this.\u00d0 = this.E(this.\u00ce.getString("armor_appearance.armor_colors.leggings", "0,100,100"));
        this.ª = this.E(this.\u00ce.getString("armor_appearance.armor_colors.boots", "0,100,100"));
        ...
        this.¤ = this.G(this.\u00ce.getString("messages.costume_equipped", "&7Za\u0142o\u017cono kostium &bNurka G\u0142\u0119binowego&7!"));
        this.\u00c0 = this.G(this.\u00ce.getString("messages.costume_removed", "&7Zdj\u0119to kostium &bNurka G\u0142\u0119binowego&7!"));
    }
    ...
    private void E() {
        ...
        this.µ = "§7Zbroja §bNurka G\u0142\u0119binowego";
        ...
        this.y = 1.0f;
        this.\u00cf = 1.0f;
        this.¤ = "§7Za\u0142o\u017cono kostium §bNurka G\u0142\u0119binowego§7!";
        this.\u00c0 = "§7Zdj\u0119to kostium §bNurka G\u0142\u0119binowego§7!";
    }
    
    private String G(String f) {
        if (f == null) {
            return null;
        }
        f = this.F(f);
    ...
    private Color E(final String s) {
        try {
    ...
    public void apply(final Player player) {
        ...
        if (playerArmorSnapshot != null) {
            if (playerArmorSnapshot.C() != null) {
                this.B(playerArmorSnapshot.C(), customHead);
            }
            if (playerArmorSnapshot.E() != null) {
                this.B(playerArmorSnapshot.E(), coloredArmor);
            }
            if (playerArmorSnapshot.B() != null) {
                this.B(playerArmorSnapshot.B(), coloredArmor2);
            }
            if (playerArmorSnapshot.A() != null) {
                this.B(playerArmorSnapshot.A(), coloredArmor3);
            }
        }
        this.B(customHead, "helmet");
        this.B(coloredArmor, "chestplate");
        this.B(coloredArmor2, "leggings");
        this.B(coloredArmor3, "boots");
    ...
    private void B(final ItemStack itemStack, final String s) {
        if (itemStack == null) {
            return;
        }
    ...
    private void B(final ItemStack itemStack, final ItemStack itemStack2) {
    ...
    public void remove(final Player player) {
        ...
        C.playerArmorMap.remove(player.getUniqueId());
    }
    ...
    public void showOriginalArmor(final Player player) {
        ...
        final I i = C.playerArmorMap.get(player.getUniqueId());
        if (i == null) {
            return;
        }
        if (i.C() != null) {
    ...
    public void applyEffects(final Player player) {
        ...
        if (this.£) {
            ...
            if (attribute != null) {
                ...
                if (C.\u00ca.containsKey(uniqueId)) {
                    attribute.setBaseValue((double)C.\u00ca.get(uniqueId));
                }
                C.\u00ca.put(uniqueId, attribute.getBaseValue());
    ...
    public void removeEffects(final Player player) {
        ...
        if (this.£ && C.\u00ca.containsKey(player.getUniqueId())) {
            final AttributeInstance attribute = player.getAttribute(Attribute.GENERIC_MAX_HEALTH);
            if (attribute != null) {
                final double doubleValue = C.\u00ca.remove(player.getUniqueId());
    ...
    private void H() {
        ...
        this.\u00c2 = new BukkitRunnable() {
            ...
            public void run() {
                final Iterator iterator = C.playerArmorMap.keySet().iterator();
                while (iterator.hasNext()) {
                    final Player player = Bukkit.getPlayer((UUID)iterator.next());
                    if (player != null && player.isOnline() && "nurekglebinowy".equals(L.D(player)) && player.isInWater()) {
                        player.addPotionEffect(new PotionEffect(PotionEffectType.DOLPHINS_GRACE, C.this.¢, C.this.\u00d3, false, false));
                    }
                }
            }
        };
    ...
    public void onPlayerDamageInWater(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (entityDamageByEntityEvent.getDamager() instanceof Player && entityDamageByEntityEvent.getEntity() instanceof LivingEntity) {
            ...
            if ("nurekglebinowy".equals(L.D(player)) && player.isInWater()) {
