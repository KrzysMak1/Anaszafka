...
public class D extends J implements Listener
{
    ...
    private void M() {
        try {
            ...
            this.\u00f1 = this.A(this.\u00fd.getConfigurationSection("activation_item.leather_color"));
            ...
            this.\u00ef = this.A(this.\u00fd.getConfigurationSection("armor.colors.chestplate"));
            this.\u00ff = this.A(this.\u00fd.getConfigurationSection("armor.colors.leggings"));
            this.\u00ea = this.A(this.\u00fd.getConfigurationSection("armor.colors.boots"));
    ...
    private Color A(final ConfigurationSection configurationSection) {
    ...
    public void apply(final Player player) {
        ...
        if (playerArmorSnapshot != null) {
            if (playerArmorSnapshot.C() != null) {
                this.C(playerArmorSnapshot.C(), customHead);
            }
            if (playerArmorSnapshot.E() != null) {
                this.C(playerArmorSnapshot.E(), coloredArmor);
            }
            if (playerArmorSnapshot.B() != null) {
                this.C(playerArmorSnapshot.B(), coloredArmor2);
            }
            if (playerArmorSnapshot.A() != null) {
                this.C(playerArmorSnapshot.A(), coloredArmor3);
            }
        }
        this.A(customHead);
        this.A(coloredArmor);
        this.A(coloredArmor2);
        this.A(coloredArmor3);
    ...
    public void remove(final Player player) {
        ...
        D.playerArmorMap.remove(player.getUniqueId());
        D.\u00e3.remove(player.getUniqueId());
        D.\u010b.remove(player.getUniqueId());
    }
    ...
    public void showOriginalArmor(final Player player) {
        ...
        final I i = D.playerArmorMap.get(player.getUniqueId());
        if (i == null) {
            return;
        }
        player.getInventory().setHelmet((i.C() != null) ? i.C().clone() : null);
        if (!i.D()) {
            player.getInventory().setChestplate((i.E() != null) ? i.E().clone() : null);
        }
        player.getInventory().setLeggings((i.B() != null) ? i.B().clone() : null);
        player.getInventory().setBoots((i.A() != null) ? i.A().clone() : null);
    }
    ...
    public void applyEffects(final Player player) {
        if (D.\u00e3.containsKey(player.getUniqueId())) {
            return;
        }
        D.\u00e3.put(player.getUniqueId(), true);
        if (this.\u00f3 > 0.0) {
    ...
    public void onPlayerDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (this.\u0109 && entityDamageByEntityEvent.getEntity() instanceof Player) {
            this.A(player, (Player)entityDamageByEntityEvent.getEntity(), damage);
        }
    }
    
    private void A(final Player player, final Player player2, final double n) {
        final UUID uniqueId = player.getUniqueId();
        final long currentTimeMillis = System.currentTimeMillis();
        if (D.\u010b.containsKey(uniqueId) && currentTimeMillis - D.\u010b.get(uniqueId) < this.\u0106 * 1000L) {
            return;
        }
        ...
        D.\u010b.put(uniqueId, currentTimeMillis);
        if (this.\u00e2 != null) {
    ...
    private void A(final Player player, final ItemStack itemStack) {
        ...
        D.\u00f4.put(player.getUniqueId(), heldItemSlot);
    ...
    public void onInventoryClose(final InventoryCloseEvent inventoryCloseEvent) {
        ...
        if (!D.\u00f4.containsKey(player.getUniqueId())) {
            return;
        }
        final int intValue = D.\u00f4.remove(player.getUniqueId());
    ...
    private void C(final ItemStack itemStack, final ItemStack itemStack2) {
    ...
    public void onVampirismDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        final UUID uniqueId = player.getUniqueId();
        final long currentTimeMillis = System.currentTimeMillis();
        if (D.\u0104.containsKey(uniqueId) && currentTimeMillis - D.\u0104.get(uniqueId) < this.\u00e7 * 1000L) {
            return;
        }
        ...
        D.\u0104.put(uniqueId, currentTimeMillis);
    }
