...
public class G extends J implements Listener
{
    ...
    public void apply(final Player player) {
        ...
        if (playerArmorSnapshot != null) {
            if (playerArmorSnapshot.C() != null) {
                this.F(playerArmorSnapshot.C(), customHead);
            }
            if (playerArmorSnapshot.E() != null) {
                this.F(playerArmorSnapshot.E(), coloredArmor);
            }
            if (playerArmorSnapshot.B() != null) {
                this.F(playerArmorSnapshot.B(), coloredArmor2);
            }
            if (playerArmorSnapshot.A() != null) {
                this.F(playerArmorSnapshot.A(), coloredArmor3);
            }
        }
        this.F(customHead, "helmet");
        this.F(coloredArmor, "chestplate");
        this.F(coloredArmor2, "leggings");
        this.F(coloredArmor3, "boots");
    ...
    private void F(final ItemStack itemStack, final String s) {
        if (itemStack == null) {
            return;
        }
    ...
    public void remove(final Player player) {
        ...
        G.playerArmorMap.remove(player.getUniqueId());
        G.\u0161.remove(player.getUniqueId());
    }
    ...
    public ItemStack getPreviewCostumeItem() {
        ...
        if (itemMeta != null) {
            ...
            final ArrayList lore = new ArrayList((Collection<? extends E>)this.\u0181);
            lore.removeIf(s2 -> {
    ...
    public void applyEffects(final Player player) {
        G.\u0161.put(player.getUniqueId(), true);
        if (this.\u0172 > 0.0) {
            ...
            if (attribute != null) {
                for (final AttributeModifier attributeModifier : new ArrayList(attribute.getModifiers())) {
                    if (attributeModifier.getUniqueId().equals(G.\u0162)) {
                        attribute.removeModifier(attributeModifier);
                        break;
                    }
                }
                attribute.addModifier(new AttributeModifier(G.\u0162, "costume_health_bonus", this.\u0172, AttributeModifier.Operation.ADD_NUMBER));
        ...
        if (this.\u0175 > 0.0) {
            ...
            if (attribute2 != null) {
                for (final AttributeModifier attributeModifier2 : new ArrayList(attribute2.getModifiers())) {
                    if (attributeModifier2.getUniqueId().equals(G.\u015e)) {
                        attribute2.removeModifier(attributeModifier2);
                        break;
                    }
                }
                attribute2.addModifier(new AttributeModifier(G.\u015e, "costume_defense_bonus", this.\u0175, AttributeModifier.Operation.MULTIPLY_SCALAR_1));
            }
        }
    }
    ...
    public void onPlayerInteractEntity(final PlayerInteractEntityEvent playerInteractEntityEvent) {
        ...
        if (!L.F(player) || !(L.A(player) instanceof G)) {
            return;
        }
        ...
        final B regionManager = Main.getInstance().getRegionManager();
        if (regionManager != null) {
            final boolean a = regionManager.A(player);
            final boolean a2 = regionManager.A(player2);
            if (a || a2) {
                final long currentTimeMillis = System.currentTimeMillis();
                if (currentTimeMillis - G.\u0164.getOrDefault(player.getUniqueId(), 0L) >= 500L) {
                    G.\u0164.put(player.getUniqueId(), currentTimeMillis);
        ...
        if (this.I(player)) {
            final long h = this.H(player);
            final long currentTimeMillis2 = System.currentTimeMillis();
            if (currentTimeMillis2 - G.\u0164.getOrDefault(player.getUniqueId(), 0L) >= 500L) {
                G.\u0164.put(player.getUniqueId(), currentTimeMillis2);
                final A languageManager = Main.getLanguageManager();
                if (languageManager != null) {
                    final String replace = languageManager.F("costume.kostium-przeciwzakazeniowy.infection-cooldown").replace("%time%", String.valueOf(h));
    ...
    private void A(final Player player, final Player player2) {
        this.L(player);
        G.\u0171.put(player2.getUniqueId(), System.currentTimeMillis() + this.\u0163 * 1000L);
        ...
        final A languageManager = Main.getLanguageManager();
        if (languageManager != null) {
            final String replace = languageManager.F("costume.kostium-przeciwzakazeniowy.infection-received").replace("%duration%", String.valueOf(this.\u0163));
            if (replace != null && !replace.isEmpty() && !replace.contains("Missing language key")) {
                player2.sendMessage(replace);
            }
            else {
                player2.sendMessage("§cZosta\u0142e\u015b zara\u017cony! B\u0119dziesz otrzymywa\u0142 wi\u0119ksze obra\u017cenia przez " + this.\u0163 + " sekund!");
            }
        }
        else {
            player2.sendMessage("§cZosta\u0142e\u015b zara\u017cony! B\u0119dziesz otrzymywa\u0142 wi\u0119ksze obra\u017cenia przez " + this.\u0163 + " sekund!");
        }
        Bukkit.getScheduler().runTaskLater((Plugin)Main.getInstance(), () -> G.\u0171.remove(player4.getUniqueId()), this.\u0163 * 20L);
    }
    ...
    public void onEntityDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        final Long n = G.\u0171.get(player.getUniqueId());
        ...
        if (entityDamageByEntityEvent.getDamager() instanceof final Player player2) {
            final B regionManager = Main.getInstance().getRegionManager();
            if (regionManager != null) {
                final boolean a = regionManager.A(player2);
    ...
    public void onPlayerDamage(final EntityDamageEvent entityDamageEvent) {
        ...
        if (!this.\u017c || !L.F(player) || !(L.A(player) instanceof G)) {
            return;
        }
    ...
    private boolean I(final Player player) {
        final Long n = G.\u016d.get(player.getUniqueId());
        return n != null && System.currentTimeMillis() < n;
    }
    
    private long H(final Player player) {
        final Long n = G.\u016d.get(player.getUniqueId());
        if (n == null) {
            return 0L;
        }
    ...
    private void L(final Player player) {
        G.\u016d.put(player.getUniqueId(), System.currentTimeMillis() + this.\u0177 * 1000L);
        Bukkit.getScheduler().runTaskLater((Plugin)Main.getInstance(), () -> G.\u016d.remove(player2.getUniqueId()), this.\u0177 * 20L);
    }
    
    private void F(final ItemStack itemStack, final ItemStack itemStack2) {
        ...
        try {
            ...
            final double e = this.E(itemStack.getType());
            final double f = this.F(itemStack.getType());
            final double g = this.G(itemStack.getType());
            if (e > 0.0) {
                itemMeta2.addAttributeModifier(Attribute.GENERIC_ARMOR, new AttributeModifier(UUID.randomUUID(), "costume_armor", e, AttributeModifier.Operation.ADD_NUMBER, this.H(itemStack2.getType())));
            }
            if (f > 0.0) {
                itemMeta2.addAttributeModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, new AttributeModifier(UUID.randomUUID(), "costume_toughness", f, AttributeModifier.Operation.ADD_NUMBER, this.H(itemStack2.getType())));
            }
            if (g > 0.0) {
                itemMeta2.addAttributeModifier(Attribute.GENERIC_KNOCKBACK_RESISTANCE, new AttributeModifier(UUID.randomUUID(), "costume_knockback_resistance", g, AttributeModifier.Operation.ADD_NUMBER, this.H(itemStack2.getType())));
            }
    ...
    private double E(final Material material) {
        switch (G$1.A[material.ordinal()]) {
            case 1: {
                return 1.0;
            }
            case 2: {
    ...
    private double F(final Material material) {
        switch (G$1.A[material.ordinal()]) {
            case 17:
            case 18:
            case 19:
    ...
    private double G(final Material material) {
        switch (G$1.A[material.ordinal()]) {
            case 21:
            case 22:
            case 23:
    ...
    private EquipmentSlot H(final Material material) {
