...
public class D
{
    ...
    public static boolean A(final String s, final String s2, final Color color) {
        final File c = C(s);
        if (!c.exists()) {
            return false;
        }
    ...
    public static boolean A(final String s, final Color color) {
        final File c = C(s);
        if (!c.exists()) {
            return false;
        }
    ...
    private static File C(final String s) {
        ...
        final File file = new File(D.A.getDataFolder(), "costumes/" + s2);
        if (!file.exists()) {
            try {
                final InputStream resource = D.A.getResource("costumes/" + s2);
                if (resource != null) {
    ...
    public static boolean A() {
        final File file = new File(D.A.getDataFolder(), "config.yml");
    ...
    public static int I(final String s) {
        final File file = new File(D.A.getCustomDataFolder(), "CostumeMenuConfig.yml");
        if (!file.exists()) {
            return -1;
        }
        try {
    ...
    public static boolean B(final String s, final int i) {
        final File file = new File(D.A.getCustomDataFolder(), "CostumeMenuConfig.yml");
        if (!file.exists()) {
            return false;
        }
