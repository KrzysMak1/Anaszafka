...
public class A implements Listener
{
    ...
    public static void setConfigManager(final B a) {
        pl.ziffy.STORMSZAFKA.costumes.preview.A.A = a;
    }
    
    public static void openPreviewMenu(final Player player) {
        int h = 54;
        String r = "§8Lista kostium\u00f3w";
        if (pl.ziffy.STORMSZAFKA.costumes.preview.A.A != null) {
            h = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.H();
            r = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.R();
        }
        final Inventory inventory = Bukkit.createInventory((InventoryHolder)null, h, r);
        if (pl.ziffy.STORMSZAFKA.costumes.preview.A.A != null) {
            final Map<List<Integer>, ItemStack> e = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.E();
            if (e != null) {
        ...
        A(inventory, player);
        if (pl.ziffy.STORMSZAFKA.costumes.preview.A.A != null) {
            final ItemStack c = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("return");
            final int e2 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.E("return", 49);
            if (c != null) {
    ...
    private static void A(final Inventory inventory) {
    ...
    private static void A(final Inventory inventory, final Player player) {
        ...
        int c8 = 31;
        if (pl.ziffy.STORMSZAFKA.costumes.preview.A.A != null) {
            c = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("zabojczykrolik", 22);
            c2 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("walentynkowy", 20);
            c3 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("przeciwzakazeniowy", 21);
            c4 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("malyurwis", 23);
            c5 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("pirata", 24);
            c6 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("nurekglebinowy", 30);
            c7 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("wampir", 32);
            c8 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("mima", 31);
        }
        final ItemStack e = L.E("zabojczykrolik");
        if (e != null) {
            inventory.setItem(c, A(e, "zabojczykrolik"));
        }
        final ItemStack e2 = L.E("walentynkowy");
        if (e2 != null) {
            inventory.setItem(c2, A(e2, "walentynkowy"));
        }
        final ItemStack e3 = L.E("przeciwzakazeniowy");
        if (e3 != null) {
            inventory.setItem(c3, A(e3, "przeciwzakazeniowy"));
        }
        final ItemStack e4 = L.E("malyurwis");
        if (e4 != null) {
            inventory.setItem(c4, A(e4, "malyurwis"));
        }
        final ItemStack e5 = L.E("pirata");
        if (e5 != null) {
            inventory.setItem(c5, A(e5, "pirata"));
        }
        final ItemStack e6 = L.E("nurekglebinowy");
        if (e6 != null) {
            inventory.setItem(c6, A(e6, "nurekglebinowy"));
        }
        final ItemStack e7 = L.E("wampir");
        if (e7 != null) {
            inventory.setItem(c7, A(e7, "wampir"));
        }
        final ItemStack e8 = L.E("mima");
        if (e8 != null) {
            inventory.setItem(c8, A(e8, "mima"));
        }
    }
    
    private static ItemStack A(final ItemStack itemStack) {
        return A(itemStack, null);
    }
    ...
    private static ItemStack A(final ItemStack itemStack, final String s) {
        ...
        if (itemMeta != null) {
            ...
            if (s != null) {
                ...
                lore.add(A(string2.replace("{cost}", String.valueOf(c))));
            }
    ...
    public void onInventoryClick(final InventoryClickEvent inventoryClickEvent) {
        ...
        int e = 49;
        if (pl.ziffy.STORMSZAFKA.costumes.preview.A.A != null) {
            e = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.E("return", 49);
        }
        int c = 22;
        int c2 = 20;
        int c3 = 21;
        ...
        if (pl.ziffy.STORMSZAFKA.costumes.preview.A.A != null) {
            ...
            c6 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("nurekglebinowy", 30);
            c7 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("wampir", 32);
            c8 = pl.ziffy.STORMSZAFKA.costumes.preview.A.A.C("mima", 33);
        }
