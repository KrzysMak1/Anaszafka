...
public class CostumesCostumeService3
{
    private final Main CostumesListener1;
    
    public CostumesCostumeService3(final Main a) {
        this.CostumesListener1 = a;
    }
    
    public boolean CostumesListener1(final CommandSender commandSender, final String[] array) {
        ...
        if (!this.CostumesListener1(lowerCase)) {
            return true;
        }
        Player player;
        if (array.length >= 4) {
        ...
        final ItemStack b = CostumesCostumeService6.CostumesListener2(lowerCase);
        if (b == null) {
            return true;
        }
    ...
    public List<String> CostumesListener2(final CommandSender commandSender, final String[] array) {
    ...
    private boolean CostumesListener1(final String s) {
    ...
    private String CostumesListener2(final String s) {
