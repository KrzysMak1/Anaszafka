...
public class UiGuiView1
{
    private final Plugin D;
    private FileConfiguration UiGuiListener1;
    private FileConfiguration UiGuiView1;
    private FileConfiguration C;
    
    public UiGuiView1(final Plugin d) {
        this.D = d;
        this.U();
    }
    ...
    public void U() {
        ...
        this.UiGuiListener1 = (FileConfiguration)YamlConfiguration.loadConfiguration(file);
        ...
        this.UiGuiView1 = (FileConfiguration)YamlConfiguration.loadConfiguration(file2);
        try {
    ...
    public void J() {
        this.UiGuiListener1 = (FileConfiguration)YamlConfiguration.loadConfiguration(new File(((Main)this.D).getCustomDataFolder(), "MenuConfig.yml"));
        this.UiGuiView1 = (FileConfiguration)YamlConfiguration.loadConfiguration(new File(((Main)this.D).getCustomDataFolder(), "PetMenuConfig.yml"));
    ...
    public String C() {
        return ChatColor.translateAlternateColorCodes('&', this.UiGuiListener1.getString("gui.title", "&8System szafki"));
    }
    
    public int L() {
        return Math.max(9, this.UiGuiListener1.getInt("gui.size", 45) / 9 * 9);
    }
    
    public String T() {
        return ChatColor.translateAlternateColorCodes('&', this.UiGuiView1.getString("gui.title", "&8Lista pet\u00f3w"));
    }
    
    public int G() {
        return Math.max(9, this.UiGuiView1.getInt("gui.size", 54) / 9 * 9);
    }
    
    public boolean O() {
        return this.UiGuiView1.getBoolean("pagination.enabled", true);
    }
    
    public int M() {
        return this.UiGuiView1.getInt("pagination.pets_per_page", 28);
    }
    
    public List<Integer> S() {
        final List integerList = this.UiGuiView1.getIntegerList("pagination.pet_slots");
    ...
    public List<String> I() {
        final ConfigurationSection configurationSection = this.UiGuiView1.getConfigurationSection("available_pets");
        if (configurationSection != null && !configurationSection.getKeys(false).isEmpty()) {
            return new ArrayList<String>(configurationSection.getKeys(false));
        }
        final List stringList = this.UiGuiView1.getStringList("available_pets");
    ...
    public ItemStack UiGuiListener1(final String s) {
        final ConfigurationSection configurationSection = this.UiGuiView1.getConfigurationSection("preview.disabled_pet_item");
        if (configurationSection == null || !configurationSection.getBoolean("enabled", true)) {
            return null;
        }
        final ItemStack a = this.UiGuiListener1(configurationSection);
    ...
    public ItemStack UiGuiListener1(final ConfigurationSection configurationSection) {
    ...
    public int F(final String s, final int n) {
        final ConfigurationSection configurationSection = this.UiGuiListener1.getConfigurationSection("items." + s);
        return (configurationSection != null) ? configurationSection.getInt("slot", n) : n;
    }
    
    public ItemStack E(final String s) {
        return this.UiGuiListener1(this.UiGuiListener1.getConfigurationSection("items." + s));
    }
    
    public int D(final String s, final int n) {
        final ConfigurationSection configurationSection = this.UiGuiListener1.getConfigurationSection("costume_items." + s);
        return (configurationSection != null) ? configurationSection.getInt("slot", n) : n;
    }
    
    public ItemStack UiGuiView1(final String s) {
        return this.UiGuiListener1(this.UiGuiListener1.getConfigurationSection("costume_items." + s));
    }
    
    public int UiGuiView1(final String s, final int n) {
        final ConfigurationSection configurationSection = this.UiGuiView1.getConfigurationSection("items." + s);
        return (configurationSection != null) ? configurationSection.getInt("slot", n) : n;
    }
    
    public ItemStack G(final String s) {
        return this.UiGuiListener1(this.UiGuiView1.getConfigurationSection("items." + s));
    }
    ...
    public ItemStack C(final String s) {
        ...
        return this.UiGuiListener1(this.C.getConfigurationSection("items." + s));
    }
    
    public boolean P() {
        return this.UiGuiView1.getBoolean("preview.show_disabled_pets", true);
    }
    
    public int UiGuiView1() {
        return this.UiGuiView1.getInt("preview.pet_display.start_slot", 10);
    }
    ...
    public int UiGuiListener1(final String s, final int n) {
        final ConfigurationSection configurationSection = this.UiGuiView1.getConfigurationSection("preview.pet_display.custom_slots");
        return (configurationSection != null && configurationSection.contains(s)) ? configurationSection.getInt(s, n) : n;
    }
    
    public boolean F() {
        return this.UiGuiView1.getBoolean("preview.pet_display.show_unavailable_message", true);
    }
    
    public String W() {
        return ChatColor.translateAlternateColorCodes('&', this.UiGuiView1.getString("preview.pet_display.unavailable_message", "&cPet niedost\u0119pny"));
    }
    
    public Map<List<Integer>, ItemStack> UiGuiListener1() {
        final HashMap hashMap = new HashMap();
        if (!this.UiGuiListener1.getBoolean("decorations.enabled", true)) {
            return hashMap;
        }
        final ConfigurationSection configurationSection = this.UiGuiListener1.getConfigurationSection("decorations.items");
        if (configurationSection == null) {
            return hashMap;
        }
        ...
        while (iterator.hasNext()) {
            ...
            final ItemStack a = this.UiGuiListener1(configurationSection2);
            if (a == null) {
                continue;
            }
    ...
    public Map<List<Integer>, ItemStack> D() {
        final HashMap hashMap = new HashMap();
        if (!this.UiGuiView1.getBoolean("decorations.enabled", true)) {
            return hashMap;
        }
        final ConfigurationSection configurationSection = this.UiGuiView1.getConfigurationSection("decorations.items");
        if (configurationSection == null) {
            return hashMap;
        }
        final Iterator iterator = configurationSection.getKeys(false).iterator();
    ...
    public String Q() {
        return this.UiGuiListener1.getString("stormszafka.title", "§8StormSzafka v1.0");
    }
    
    public int N() {
        return this.UiGuiListener1.getInt("stormszafka.size", 27);
    }
    
    public HashMap<List<Integer>, ItemStack> K() {
        return this.UiGuiView1(this.UiGuiListener1.getConfigurationSection("stormszafka.decorations"));
    }
    
    private HashMap<List<Integer>, ItemStack> UiGuiView1(final ConfigurationSection configurationSection) {
        final HashMap hashMap = new HashMap();
        if (configurationSection == null) {
            return hashMap;
        }
