...
public class K implements D, Listener
{
    ...
    private void L() {
        final Map<String, Object> d = this.\u0144.D("nietoperek");
        this.\u0148 = (double)d.get("height");
        this.\u014b = (double)d.get("speed");
        this.\u0145 = (double)d.get("distance");
        final Map<String, Object> d2 = this.\u0144.D("nietoperek", "void_damage_reduction");
        this.\u014a = (double)(d2.containsKey("reduction") ? d2.get("reduction") : 0.5);
        final Map<String, Object> d3 = this.\u0144.D("nietoperek", "speed");
    ...
    public void spawn(final Player \u013e, final String s) {
        ...
        String string;
        if (this.\u0144 != null) {
            final Object b = this.\u0144.B("nietoperek", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0144.G("nietoperek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjc2NjA1ODA3MDgzOWYxZmY0YzU4YTUyM2E3ZGI5MDVkN2E4YmFhYjZhMjU5MDYzYmMwOTQ2YTNiNzRhZmU5ZSJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u0140 = (ArmorStand)\u013e.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u0144.L("nietoperek") + " &8\u25cf &f" + \u013e.getName()));
            this.J(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u013e.getUniqueId());
        final Map<String, Object> a = this.\u0144.A("nietoperek");
        E.A(this.\u014d = (ArmorStand)\u013e.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u013e.getName()));
    ...
    public void update() {
        ...
        this.\u0140.teleport(add);
        this.\u014d.teleport(add.clone().add(0.0, (double)this.\u0144.A("nietoperek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u0144.G("nietoperek").getString("name", "Nietoperek");
    }
    ...
    private void J(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
