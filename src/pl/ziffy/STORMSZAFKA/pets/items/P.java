...
public class P implements D, Listener
{
    ...
    private void R() {
        try {
            final Map<String, Object> d = this.\u01a7.D("telekrolik");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u01a7.D("telekrolik", "damage");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u01a7.D("telekrolik", "damage_reduction");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u01a7.D("telekrolik", "health_tracking");
            if (d4 != null) {
    ...
    public void spawn(final Player \u0272, final String s) {
        ...
        String string;
        if (this.\u01a7 != null) {
            final Object b = this.\u01a7.B("telekrolik", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u01a7.G("telekrolik").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvN2RmMjkyNmU5NzA2MTFhNjlkZTczMjZiZjgzNWY2YzA1OTI1M2NiNmUzN2UzZjgxZTc2NzZiZTE4MWQ4Mzg4MCJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u01a0 = (ArmorStand)\u0272.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u01a7.L("telekrolik") + " &8\u25cf &f" + \u0272.getName()));
            this.O(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0272.getUniqueId());
        final Map<String, Object> a = this.\u01a7.A("telekrolik");
        E.A(this.\u01b0 = (ArmorStand)\u0272.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u0272.getName()));
    ...
    public void update() {
        ...
        this.\u01a0.teleport(add);
        this.\u01b0.teleport(add.clone().add(0.0, (double)this.\u01a7.A("telekrolik").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u01a7.G("telekrolik").getString("name", "Telekr\u00f3lik");
    }
    ...
    private void L(final Player player) {
        ...
        this.\u01aa.put(player.getUniqueId(), Bukkit.getScheduler().runTaskTimer(Bukkit.getPluginManager().getPlugin("STORMSZAFKA"), () -> this.I(player2), 0L, 20L));
    ...
    private void I(final Player player) {
    ...
    private void O(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
