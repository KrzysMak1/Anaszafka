...
public class PetsItemsPetItemDefinition17 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u019b;
    private PetsItemsPetItemDefinition7 \u0191;
    private double \u0193;
    private double \u0194;
    private double \u018e;
    private int \u018f;
    
    public PetsItemsPetItemDefinition17() {
        this.\u0192 = 0.0;
        this.\u019b = false;
        ...
        this.PetsItemsPetItemDefinition19();
    }
    
    private void PetsItemsPetItemDefinition19() {
        final Map<String, Object> d = this.\u0191.PetsItemsPetItemDefinition4("pancernik");
        this.\u0194 = (double)d.get("height");
        this.\u0193 = (double)d.get("speed");
        this.\u018e = (double)d.get("distance");
        this.\u018f = this.\u0191.PetsItemsPetItemDefinition4("pancernik", "defense").get("percentage");
    }
    ...
    public void spawn(final Player \u025b, final String s) {
        ...
        String string;
        if (this.\u0191 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u0191.PetsItemsPetItemDefinition2("pancernik", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0191.PetsItemsPetItemDefinition7("pancernik").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzcwMThhMGRmMzYyNjNjZTQ3NjIwNmNhM2JmMGQ4OTRlNzJmZDBlNjU1YTU3NTNhNzdhNzNmMTQyNDViN2RhIn19fQ==");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u0198 = (ArmorStand)\u025b.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u0191.PetsItemsPetItemDefinition12("pancernik") + " &8\u25cf &f" + \u025b.getName()));
            this.PetsItemsPetItemDefinition16(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u025b.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u0191.PetsItemsPetItemDefinition1("pancernik");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u019a = (ArmorStand)\u025b.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u025b.getName()));
    ...
    public void update() {
        ...
        this.\u0198.teleport(add);
        this.\u019a.teleport(add.clone().add(0.0, (double)this.\u0191.PetsItemsPetItemDefinition1("pancernik").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u0191.PetsItemsPetItemDefinition7("pancernik").getString("name", "Pancernik");
    }
    ...
    private void PetsItemsPetItemDefinition16(final SkullMeta skullMeta, final String s) {
