...
public class PetsItemsPetItemDefinition20 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u01d8;
    private boolean \u01d6;
    private PetsItemsPetItemDefinition7 \u01d3;
    private double \u01d9;
    private double \u01d7;
    private double \u01d4;
    private double \u01cc;
    ...
    public PetsItemsPetItemDefinition20() {
        this.\u01d0 = 0.0;
        this.\u01d8 = false;
        this.\u01d6 = true;
        ...
        this.PetsItemsPetItemDefinition22();
    }
    
    private void PetsItemsPetItemDefinition22() {
        try {
            final Map<String, Object> d = this.\u01d3.PetsItemsPetItemDefinition4("elfik");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u01d3.PetsItemsPetItemDefinition4("elfik", "defense");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u01d3.PetsItemsPetItemDefinition4("elfik", "dripstone_reduction");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u01d3.PetsItemsPetItemDefinition4("elfik", "damage");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u01d3.PetsItemsPetItemDefinition4("elfik", "hunger");
            if (d5 != null) {
    ...
    public void spawn(final Player \u01c9, final String s) {
        ...
        String string;
        if (this.\u01d3 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u01d3.PetsItemsPetItemDefinition2("elfik", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u01d3.PetsItemsPetItemDefinition7("elfik").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGFkMzNhYjY0YzgxYjQzYmY0YmY1MjYxZGZkZDg0YjgxMjkxNTJkZDdiMTIyNjFmNWRhY2I3NzM2MjkyMmE1ZCJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u01cf = (ArmorStand)\u01c9.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u01d3.PetsItemsPetItemDefinition12("elfik") + " &8\u25cf &f" + \u01c9.getName()));
            this.PetsItemsPetItemDefinition19(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u01c9.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u01d3.PetsItemsPetItemDefinition1("elfik");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u01dd = (ArmorStand)\u01c9.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u01c9.getName()));
    ...
    public void update() {
        ...
        this.\u01cf.teleport(add);
        this.\u01dd.teleport(add.clone().add(0.0, (double)this.\u01d3.PetsItemsPetItemDefinition1("elfik").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u01d3.PetsItemsPetItemDefinition7("elfik").getString("name", "Elfik");
    }
    ...
    private void PetsItemsPetItemDefinition19(final SkullMeta skullMeta, final String s) {
