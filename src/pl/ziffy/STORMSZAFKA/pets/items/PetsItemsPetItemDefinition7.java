...
public class PetsItemsPetItemDefinition7 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u00f5;
    private boolean \u00f1;
    private pl.ziffy.STORMSZAFKA.pets.PetsItemsPetItemDefinition7 \u00ee;
    private double \u00f6;
    private double \u00f3;
    private double \u00f0;
    private double \u00f4;
    ...
    public PetsItemsPetItemDefinition7() {
        this.\u00ec = 0.0;
        this.\u00f5 = false;
        this.\u00f1 = true;
        ...
        this.PetsItemsPetItemDefinition8();
    }
    
    private void PetsItemsPetItemDefinition8() {
        final Map<String, Object> d = this.\u00ee.PetsItemsPetItemDefinition4("discordzik");
        this.\u00f3 = (double)d.get("height");
        this.\u00f6 = (double)d.get("speed");
        this.\u00f0 = (double)d.get("distance");
        final Map<String, Object> d2 = this.\u00ee.PetsItemsPetItemDefinition4("discordzik", "fall_damage_reduction");
        this.\u00f4 = (double)(d2.containsKey("reduction") ? d2.get("reduction") : 0.75);
        final Map<String, Object> d3 = this.\u00ee.PetsItemsPetItemDefinition4("discordzik", "damage_bonus");
        this.\u00ef = (double)(d3.containsKey("bonus") ? d3.get("bonus") : 1.0);
        final Map<String, Object> d4 = this.\u00ee.PetsItemsPetItemDefinition4("discordzik", "health");
    ...
    public void spawn(final Player \u00e8, final String s) {
        ...
        String string;
        if (this.\u00ee != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u00ee.PetsItemsPetItemDefinition2("discordzik", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u00ee.PetsItemsPetItemDefinition7("discordzik").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNmM4NGQxYTkwOTVhNjNmNDc1NDY3MjBmZTdmNmVkZjAzZTEyMjc2ZTA2MmI4NTNlMjA3YTVjNjk3ZjFlNTIxIn19fQ==");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u00eb = (ArmorStand)\u00e8.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(pl.ziffy.STORMSZAFKA.pets.PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u00ee.PetsItemsPetItemDefinition12("discordzik") + " &8\u25cf &f" + \u00e8.getName()));
            this.PetsItemsPetItemDefinition6(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u00e8.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u00ee.PetsItemsPetItemDefinition1("discordzik");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u00f9 = (ArmorStand)\u00e8.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(pl.ziffy.STORMSZAFKA.pets.PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u00e8.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u00e8.getUniqueId());
        try {
            \u00e8.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition7.\u00f2)).forEach(attributeModifier2 -> player.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
            \u00e8.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(PetsItemsPetItemDefinition7.\u00f2, "discordzik_health_bonus", this.\u00ea, AttributeModifier.Operation.ADD_NUMBER));
    ...
    public void update() {
        ...
        this.\u00eb.teleport(add);
        this.\u00f9.teleport(add.clone().add(0.0, (double)this.\u00ee.PetsItemsPetItemDefinition1("discordzik").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        try {
            if (this.\u00e8 != null && this.\u00e8.isOnline()) {
                this.\u00e8.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition7.\u00f2)).forEach(attributeModifier2 -> this.\u00e8.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
    ...
    public String getDisplayName() {
        return this.\u00ee.PetsItemsPetItemDefinition7("discordzik").getString("name", "Discordzik");
    }
    ...
    private void PetsItemsPetItemDefinition6(final SkullMeta skullMeta, final String s) {
