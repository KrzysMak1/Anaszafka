...
public class U implements D, Listener
{
    ...
    private void W() {
        try {
            final Map<String, Object> d = this.\u020e.D("pudzianek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u020e.D("pudzianek", "damage");
            if (d2 != null) {
    ...
    public void spawn(final Player \u020d, final String s) {
        ...
        String string;
        if (this.\u020e != null) {
            final Object b = this.\u020e.B("pudzianek", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u020e.G("pudzianek").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjE3OWFlNzlkMGNjZmE0MGNmMWQwMDczNjkwY2MzNjMwNjUzYjA3ZGUyYTA5ZDhlOTRlYjU4NTM4N2E2YjBkMiJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u0217 = (ArmorStand)\u020d.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u020e.L("pudzianek") + " &8\u25cf &f" + \u020d.getName()));
            this.T(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u020d.getUniqueId());
        final Map<String, Object> a = this.\u020e.A("pudzianek");
        E.A(this.\u0252 = (ArmorStand)\u020d.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u020d.getName()));
    ...
    public void update() {
        ...
        this.\u0217.teleport(add);
        this.\u0252.teleport(add.clone().add(0.0, (double)this.\u020e.A("pudzianek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u020e.G("pudzianek").getString("name", "Pudzianek");
    }
    ...
    private void T(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
