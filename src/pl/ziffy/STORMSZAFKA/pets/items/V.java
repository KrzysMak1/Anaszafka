...
public class V implements D, Listener
{
    ...
    private void X() {
        try {
            final Map<String, Object> d = this.\u025d.D("cukiereczek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u025d.D("cukiereczek", "speed");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u025d.D("cukiereczek", "fire_resistance");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u025d.D("cukiereczek", "damage");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u025d.D("cukiereczek", "sword_defense");
            if (d5 != null) {
    ...
    public void spawn(final Player \u0255, final String s) {
        ...
        String string;
        if (this.\u025d != null) {
            final Object b = this.\u025d.B("cukiereczek", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u025d.G("cukiereczek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWI0YjVjNzQ4MzA2MDlmOWNlN2JmYjhjYTI2ZmFjMTcxZWRiYzZiMjdjNjM3ZWExMDFmYzFhZTFhMmZhYzQ0MSJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u0259 = (ArmorStand)\u0255.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u025d.L("cukiereczek") + " &8\u25cf &f" + \u0255.getName()));
            this.U(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0255.getUniqueId());
        final Map<String, Object> a = this.\u025d.A("cukiereczek");
        E.A(this.\u0269 = (ArmorStand)\u0255.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u0255.getName()));
    ...
    public void update() {
        ...
        this.\u0259.teleport(add);
        this.\u0269.teleport(add.clone().add(0.0, (double)this.\u025d.A("cukiereczek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u025d.G("cukiereczek").getString("name", "Cukiereczek");
    }
    ...
    public void onEntityDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (this.\u0255 != null && entityDamageByEntityEvent.getEntity() instanceof Player && ((Player)entityDamageByEntityEvent.getEntity()).getUniqueId().equals(this.\u0255.getUniqueId()) && entityDamageByEntityEvent.getDamager() instanceof Player && this.B(((Player)entityDamageByEntityEvent.getDamager()).getInventory().getItemInMainHand().getType())) {
    ...
    private boolean B(final Material material) {
    ...
    private void U(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
