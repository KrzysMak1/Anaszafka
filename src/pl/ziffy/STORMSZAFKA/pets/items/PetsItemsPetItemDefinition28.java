...
public class PetsItemsPetItemDefinition28 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u029e;
    private PetsItemsPetItemDefinition7 \u0296;
    ...
    public PetsItemsPetItemDefinition28() {
        this.\u028f = 0.0;
        this.\u029e = false;
        this.\u0296 = Main.getPetConfigManager();
        this.PetsItemsPetItemDefinition14();
    }
    
    private void PetsItemsPetItemDefinition14() {
        try {
            final Map<String, Object> d = this.\u0296.PetsItemsPetItemDefinition4("drakula");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u0296.PetsItemsPetItemDefinition4("drakula", "durability");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u0296.PetsItemsPetItemDefinition4("drakula", "life_steal");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u0296.PetsItemsPetItemDefinition4("drakula", "health");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u0296.PetsItemsPetItemDefinition4("drakula", "speed");
            if (d5 != null) {
            ...
            final Map<String, Object> d6 = this.\u0296.PetsItemsPetItemDefinition4("drakula", "vampirism");
            if (d6 != null) {
    ...
    public void spawn(final Player \u028a, final String s) {
        ...
        String string;
        if (this.\u0296 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u0296.PetsItemsPetItemDefinition2("drakula", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0296.PetsItemsPetItemDefinition7("drakula").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGMwNTk4ZjY4YzAyNGFhMTQ2OTgzZTg2OTRjMDBjMGEyZjNmMWVhMWQ3OWIyYjM4MWJhYzc5ZTU4NjhkNjRjYSJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u028d = (ArmorStand)\u028a.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u0296.PetsItemsPetItemDefinition12("drakula") + " &8\u25cf &f" + \u028a.getName()));
            this.PetsItemsPetItemDefinition27(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u028a.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u0296.PetsItemsPetItemDefinition1("drakula");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u02a3 = (ArmorStand)\u028a.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u028a.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u028a.getUniqueId());
        if (\u028a.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().noneMatch(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition28.\u029c))) {
            \u028a.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(PetsItemsPetItemDefinition28.\u029c, "Drakula hearts", this.\u0293 * 2.0, AttributeModifier.Operation.ADD_NUMBER));
        }
    ...
    public void update() {
        ...
        this.\u028d.teleport(add);
        this.\u02a3.teleport(add.clone().add(0.0, (double)this.\u0296.PetsItemsPetItemDefinition1("drakula").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        if (this.\u028a != null && this.\u028a.isOnline()) {
            this.\u028a.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition28.\u029c)).findFirst().ifPresent(attributeModifier2 -> this.\u028a.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
    ...
    public String getDisplayName() {
        return this.\u0296.PetsItemsPetItemDefinition7("drakula").getString("name", "Drakula");
    }
    ...
    public void onPlayerDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        ...
        if (!PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition11(player) || !"drakula".equals(PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition7(player))) {
            return;
        }
        ...
        if (PetsItemsPetItemDefinition28.\u0298.containsKey(uniqueId) && currentTimeMillis - PetsItemsPetItemDefinition28.\u0298.get(uniqueId) < this.\u02a1 * 1000L) {
            return;
        }
        ...
        PetsItemsPetItemDefinition28.\u0298.put(uniqueId, currentTimeMillis);
    }
    
    private void PetsItemsPetItemDefinition27(final SkullMeta skullMeta, final String s) {
    ...
    static {
        ...
        PetsItemsPetItemDefinition28.\u0294 = false;
    }
}
