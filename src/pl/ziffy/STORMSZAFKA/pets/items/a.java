...
public class a implements D, Listener
{
    ...
    private void e() {
        try {
            final Map<String, Object> d = this.\u039a.D("balwanek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u039a.D("balwanek", "defense");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u039a.D("balwanek", "speed");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u039a.D("balwanek", "damage");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u039a.D("balwanek", "drop");
            if (d5 != null) {
    ...
    public void spawn(final Player \u0390, final String s) {
        ...
        String string;
        if (this.\u039a != null) {
            final Object b = this.\u039a.B("balwanek", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u039a.G("balwanek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODdiYTE0NjI0NWRhMDE2NWU2YTQ1OWQwZGMyZDEyZDc3YTk2OTAzMmQxYzU2YWEwYjA5MTYwNTlmMjAyZGRkIn19fQ==");
            }
        }
        else {
        ...
        E.B(this.\u0396 = (ArmorStand)\u0390.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u039a.L("balwanek") + " &8\u25cf &f" + \u0390.getName()));
            this._(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0390.getUniqueId());
        final Map<String, Object> a = this.\u039a.A("balwanek");
        E.A(this.\u03a7 = (ArmorStand)\u0390.getWorld().spawn(add.clone().add(0.0, (a != null && a.get("height") instanceof Number) ? ((Number)a.get("height")).doubleValue() : 2.0, 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u0390.getName()));
    ...
    public void update() {
        ...
        this.\u0396.teleport(add);
        final Map<String, Object> a = this.\u039a.A("balwanek");
        this.\u03a7.teleport(add.clone().add(0.0, (a != null && a.get("height") instanceof Number) ? ((Number)a.get("height")).doubleValue() : 2.0, 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u039a.G("balwanek").getString("name", "Ba\u0142wanek");
    }
    ...
    public void onBlockBreak(final BlockBreakEvent blockBreakEvent) {
        ...
        if (a.\u039c.contains(type) || a.\u039f.contains(type)) {
            final Collection drops = blockBreakEvent.getBlock().getDrops(blockBreakEvent.getPlayer().getInventory().getItemInMainHand());
            if (a.\u039f.contains(type) && blockBreakEvent.getBlock().getBlockData() instanceof Ageable) {
    ...
    private void _(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
