...
public class PetsItemsPetItemDefinition16 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u018d;
    private PetsItemsPetItemDefinition7 \u0183;
    private double \u0185;
    private double \u0186;
    private double \u0180;
    private double \u0181;
    
    public PetsItemsPetItemDefinition16() {
        this.\u0184 = 0.0;
        this.\u018d = false;
        ...
        this.PetsItemsPetItemDefinition18();
    }
    
    private void PetsItemsPetItemDefinition18() {
        final Map<String, Object> d = this.\u0183.PetsItemsPetItemDefinition4("skalniaczek");
        this.\u0186 = (double)d.get("height");
        this.\u0185 = (double)d.get("speed");
        this.\u0180 = (double)d.get("distance");
        final Map<String, Object> d2 = this.\u0183.PetsItemsPetItemDefinition4("skalniaczek", "dripstone_protection");
    ...
    public void spawn(final Player \u0183, final String s) {
        ...
        String string;
        if (this.\u0183 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u0183.PetsItemsPetItemDefinition2("skalniaczek", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0183.PetsItemsPetItemDefinition7("skalniaczek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzk4NWY3MGI1YWM0M2RlNzJhYTgwNzcyZTE0MWU0ZjUzOGIyMzIwYzdhM2IyZWFmM2Q5NGMwOWEzMzI0MTNmMiJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u018a = (ArmorStand)\u0183.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u0183.PetsItemsPetItemDefinition12("skalniaczek") + " &8\u25cf &f" + \u0183.getName()));
            this.PetsItemsPetItemDefinition15(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0183.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u0183.PetsItemsPetItemDefinition1("skalniaczek");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u018c = (ArmorStand)\u0183.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u0183.getName()));
    ...
    public void update() {
        ...
        this.\u018a.teleport(add);
        this.\u018c.teleport(add.clone().add(0.0, (double)this.\u0183.PetsItemsPetItemDefinition1("skalniaczek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u0183.PetsItemsPetItemDefinition7("skalniaczek").getString("name", "Skalniaczek");
    }
    ...
    private void PetsItemsPetItemDefinition15(final SkullMeta skullMeta, final String s) {
