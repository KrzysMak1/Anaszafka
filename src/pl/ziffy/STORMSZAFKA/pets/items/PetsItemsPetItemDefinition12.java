...
public class PetsItemsPetItemDefinition12 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u015f;
    private Random \u014f;
    private PetsItemsPetItemDefinition7 \u0159;
    private double \u0162;
    private double \u0160;
    private double \u015d;
    private int \u0157;
    ...
    public PetsItemsPetItemDefinition12() {
        this.\u0156 = 0.0;
        this.\u0161 = false;
        this.\u015f = true;
        this.\u014f = new Random();
        ...
        this.PetsItemsPetItemDefinition15();
    }
    
    private void PetsItemsPetItemDefinition15() {
        try {
            final Map<String, Object> d = this.\u0159.PetsItemsPetItemDefinition4("rozdymek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u0159.PetsItemsPetItemDefinition4("rozdymek", "speed");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u0159.PetsItemsPetItemDefinition4("rozdymek", "water_breathing");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u0159.PetsItemsPetItemDefinition4("rozdymek", "extra_fishing");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u0159.PetsItemsPetItemDefinition4("rozdymek", "negative_effect_reduction");
            if (d5 != null) {
    ...
    public void spawn(final Player \u0151, final String s) {
        ...
        String string;
        if (this.\u0159 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u0159.PetsItemsPetItemDefinition2("rozdymek", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0159.PetsItemsPetItemDefinition7("rozdymek").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTI2NmY1NGExZjJiODZmZDhmZDAxNjNhOWQyMmE5YjZiM2E0YzkzODk1Mjk3YmM3ZWU2Nzg4NzA4ZjRkOTc0NSJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u0154 = (ArmorStand)\u0151.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u0159.PetsItemsPetItemDefinition12("rozdymek") + " &8\u25cf &f" + \u0151.getName()));
            this.PetsItemsPetItemDefinition11(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0151.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u0159.PetsItemsPetItemDefinition1("rozdymek");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u0164 = (ArmorStand)\u0151.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u0151.getName()));
    ...
    public void update() {
        ...
        this.\u0154.teleport(add);
        this.\u0164.teleport(add.clone().add(0.0, (double)this.\u0159.PetsItemsPetItemDefinition1("rozdymek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u0159.PetsItemsPetItemDefinition7("rozdymek").getString("name", "Rozdymek");
    }
    ...
    public void onPlayerFish(final PlayerFishEvent playerFishEvent2) {
        ...
        if (this.\u0150 != null && playerFishEvent2.getPlayer().getUniqueId().equals(this.\u0150.getUniqueId()) && playerFishEvent2.getState() == PlayerFishEvent.State.CAUGHT_FISH && this.\u014f.nextDouble() < this.\u0151 && playerFishEvent2.getCaught() != null) {
            Bukkit.getScheduler().runTaskLater(Bukkit.getPluginManager().getPlugin("STORMSZAFKA"), () -> {
                ...
                this.\u0150.getWorld().dropItemNaturally(location, this.PetsItemsPetItemDefinition16());
            }, 1L);
        }
    }
    
    private ItemStack PetsItemsPetItemDefinition16() {
    ...
    public void onPotionEffect(final EntityPotionEffectEvent entityPotionEffectEvent) {
        ...
        if (this.\u0150 != null && entityPotionEffectEvent.getEntity() instanceof Player && entityPotionEffectEvent.getEntity().getUniqueId().equals(this.\u0150.getUniqueId()) && entityPotionEffectEvent.getAction() == EntityPotionEffectEvent.Action.ADDED) {
            ...
            if (potionEffect2 != null && this.PetsItemsPetItemDefinition1(potionEffect2.getType())) {
        ...
        if (this.\u0150 != null && entityDamageByEntityEvent.getEntity() instanceof Player && entityDamageByEntityEvent.getEntity().getUniqueId().equals(this.\u0150.getUniqueId()) && entityDamageByEntityEvent.getDamager() instanceof Arrow) {
            ...
            if (arrow.hasCustomEffects()) {
                arrow.getCustomEffects().forEach(potionEffect -> {
                    if (this.PetsItemsPetItemDefinition1(potionEffect.getType())) {
                        Bukkit.getScheduler().runTaskLater(Bukkit.getPluginManager().getPlugin("STORMSZAFKA"), () -> {
    ...
    private boolean PetsItemsPetItemDefinition1(final PotionEffectType potionEffectType) {
    ...
    private void PetsItemsPetItemDefinition11(final SkullMeta skullMeta, final String s) {
