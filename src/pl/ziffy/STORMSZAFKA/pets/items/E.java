...
public class E implements D, Listener
{
    ...
    private void F() {
        try {
            final Map<String, Object> d = this.\u00c5.D("cyber-obronca");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u00c5.D("cyber-obronca", "damage");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u00c5.D("cyber-obronca", "health_view");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u00c5.D("cyber-obronca", "haste");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u00c5.D("cyber-obronca", "water_resistance");
            if (d5 != null) {
    ...
    public void spawn(final Player £, final String s) {
        ...
        String string;
        if (this.\u00c5 != null) {
            final Object b = this.\u00c5.B("cyber-obronca", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u00c5.G("cyber-obronca").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTE2Mzk1NDQ0NjZlNTU1OWE4YzViYzNjN2YwYzVmNzM4NjcwNmY3N2IwYTAwOTljZTU1NTU5OWRlNmJmZTk1NSJ9fX0=");
            }
        }
        else {
        ...
        pl.ziffy.STORMSZAFKA.pets.E.B(this.º = (ArmorStand)£.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u00c5.L("cyber-obronca") + " &8\u25cf &f" + £.getName()));
            this.D(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), £.getUniqueId());
        final Map<String, Object> a = this.\u00c5.A("cyber-obronca");
        pl.ziffy.STORMSZAFKA.pets.E.A(this.\u00cf = (ArmorStand)£.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + £.getName()));
    ...
    public void update() {
        ...
        this.º.teleport(add);
        this.\u00cf.teleport(add.clone().add(0.0, (double)this.\u00c5.A("cyber-obronca").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u00c5.G("cyber-obronca").getString("name", "Cyber-Obro\u0144ca");
    }
    ...
    public void onEntityDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        if (this.£ != null && entityDamageByEntityEvent.getDamager() instanceof Player && this.\u00c9 && ((Player)entityDamageByEntityEvent.getDamager()).getUniqueId().equals(this.£.getUniqueId())) {
            ...
            if (this.\u00c3 && entityDamageByEntityEvent.getEntity() instanceof Player) {
                this.A((Player)entityDamageByEntityEvent.getEntity());
            }
        }
    }
    ...
    private void A(final Player player) {
        ...
        this.\u00c8.put(player.getUniqueId(), Bukkit.getScheduler().runTaskTimer(Bukkit.getPluginManager().getPlugin("STORMSZAFKA"), () -> this.D(player2), 0L, 20L));
    ...
    private void D(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
