...
public class Z implements D, Listener
{
    ...
    private void c() {
        try {
            final Map<String, Object> d = this.\u02b4.D("enderman");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u02b4.D("enderman", "damage");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u02b4.D("enderman", "pearl");
            if (d3 != null) {
    ...
    public void spawn(final Player \u02a6, final String s) {
        ...
        String string;
        if (this.\u02b4 != null) {
            final Object b = this.\u02b4.B("enderman", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u02b4.G("enderman").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNmE2NDlhM2QxYWFlODgwYWNjYzQ3M2M2YzE1YTYzZWU1Y2IwMGYwNjAzMTkzZmM5ZjdjYzkxODdkODAzNmM3ZSJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u02a8 = (ArmorStand)\u02a6.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u02b4.L("enderman") + " &8\u25cf &f" + \u02a6.getName()));
            this.Y(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u02a6.getUniqueId());
        final Map<String, Object> a = this.\u02b4.A("enderman");
        E.A(this.\u02c0 = (ArmorStand)\u02a6.getWorld().spawn(add.clone().add(0.0, (a != null && a.get("height") instanceof Number) ? ((Number)a.get("height")).doubleValue() : 2.0, 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u02a6.getName()));
    ...
    public void update() {
        ...
        this.\u02a8.teleport(add);
        final Map<String, Object> a = this.\u02b4.A("enderman");
        this.\u02c0.teleport(add.clone().add(0.0, (a != null && a.get("height") instanceof Number) ? ((Number)a.get("height")).doubleValue() : 2.0, 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u02b4.G("enderman").getString("name", "Enderman");
    }
    ...
    private void Y(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
