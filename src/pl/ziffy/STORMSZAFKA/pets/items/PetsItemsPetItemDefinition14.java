...
public class PetsItemsPetItemDefinition14 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u03b8;
    private PetsItemsPetItemDefinition7 \u03b1;
    ...
    public PetsItemsPetItemDefinition14() {
        this.\u03ae = 0.0;
        this.\u03b8 = false;
    ...
    private void f() {
        try {
            final Map<String, Object> d = this.\u03b1.PetsItemsPetItemDefinition4("golemik");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u03b1.PetsItemsPetItemDefinition4("golemik", "defense");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u03b1.PetsItemsPetItemDefinition4("golemik", "dripstone_protection");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u03b1.PetsItemsPetItemDefinition4("golemik", "health");
            if (d4 != null) {
    ...
    public void spawn(final Player \u03c9, final String s) {
        ...
        String string;
        if (this.\u03b1 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u03b1.PetsItemsPetItemDefinition2("golemik", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u03b1.PetsItemsPetItemDefinition7("golemik").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGE2ZTA0MjljY2FhYmI2ZjVmMGM1ZDUxM2M3OTViZWQ2ZDgwZmNlNzJmNTdmNGJjM2E2MTZhZWUyM2UxMjU3MiJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u03ad = (ArmorStand)\u03c9.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u03b1.PetsItemsPetItemDefinition12("golemik") + " &8\u25cf &f" + \u03c9.getName()));
            this.PetsItemsPetItemDefinition13(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u03c9.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u03b1.PetsItemsPetItemDefinition1("golemik");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u03bb = (ArmorStand)\u03c9.getWorld().spawn(add.clone().add(0.0, (PetsItemsPetItemDefinition13 != null && PetsItemsPetItemDefinition13.get("height") instanceof Number) ? ((Number)PetsItemsPetItemDefinition13.get("height")).doubleValue() : 2.3, 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u03c9.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u03c9.getUniqueId());
        if (\u03c9.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().noneMatch(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition14.\u03b6))) {
            \u03c9.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(PetsItemsPetItemDefinition14.\u03b6, "Golemin hearts", this.\u03af * 2.0, AttributeModifier.Operation.ADD_NUMBER));
        }
    }
    ...
    public void update() {
        ...
        this.\u03ad.teleport(add);
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u03b1.PetsItemsPetItemDefinition1("golemik");
        this.\u03bb.teleport(add.clone().add(0.0, (PetsItemsPetItemDefinition13 != null && PetsItemsPetItemDefinition13.get("height") instanceof Number) ? ((Number)PetsItemsPetItemDefinition13.get("height")).doubleValue() : 2.3, 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        if (this.\u03a9 != null && this.\u03a9.isOnline()) {
            this.\u03a9.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition14.\u03b6)).findFirst().ifPresent(attributeModifier2 -> this.\u03a9.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
        }
    }
    
    @Override
    public String getDisplayName() {
        return this.\u03b1.PetsItemsPetItemDefinition7("golemik").getString("name", "Golemik");
    }
    ...
    private void PetsItemsPetItemDefinition13(final SkullMeta skullMeta, final String s) {
