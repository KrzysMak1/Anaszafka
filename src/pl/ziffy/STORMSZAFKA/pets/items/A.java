...
public class A implements D
{
    ...
    private void h() {
        final Map<String, Object> d = this.\u03c7.D("pedziwiatr");
        this.\u03ce = (double)d.get("height");
        this.\u03d2 = (double)d.get("speed");
        this.\u03cb = (double)d.get("distance");
        final Map<String, Object> d2 = this.\u03c7.D("pedziwiatr", "speed");
        ...
        final FileConfiguration g = this.\u03c7.G("pedziwiatr");
    ...
    public void spawn(final Player \u03bd, final String s) {
        ...
        final Location a = this.A(location, location.getDirection());
        String string;
        if (this.\u03c7 != null) {
            final Object b = this.\u03c7.B("pedziwiatr", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u03c7.G("pedziwiatr").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzYyNmIxZmY1ZmQyY2IwYzFhZWI1MzYxMzIzMmZmZThhYjgxYmQzM2Q1NWJlMWYzYTkyZTdkNmZjN2ZkNjNhMCJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u03c2 = (ArmorStand)\u03bd.getWorld().spawn(a, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u03c7.L("pedziwiatr") + " &8\u25cf &f" + \u03bd.getName()));
            this.b(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u03bd.getUniqueId());
        final Map<String, Object> a2 = this.\u03c7.A("pedziwiatr");
        E.A(this.\u03d5 = (ArmorStand)\u03bd.getWorld().spawn(a.clone().add(0.0, (double)a2.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u03bd.getName()));
    ...
    public void update() {
        ...
        final boolean b = this.\u03bd.hasPotionEffect(PotionEffectType.INVISIBILITY) || this.\u03bd.getGameMode() == GameMode.SPECTATOR;
        final Location location = this.\u03bd.getLocation();
        final Location a = this.A(location, location.getDirection());
        if (this.\u03c8) {
            this.\u03c4 += this.\u03d2;
            final double n = this.\u03c4 % 2.0;
            a.add(0.0, (n <= 1.0) ? (n * this.\u03ce) : ((2.0 - n) * this.\u03ce), 0.0);
        }
        if (this.\u03c0) {
            a.setYaw(location.getYaw());
        }
        this.\u03c2.teleport(a);
        this.\u03d5.teleport(a.clone().add(0.0, (double)this.\u03c7.A("pedziwiatr").get("height"), 0.0));
        if (this.\u03d0) {
            final long currentTimeMillis = System.currentTimeMillis();
            if (currentTimeMillis - this.\u03c5 > this.\u03c3 * 1000) {
                try {
                    this.\u03bd.getWorld().playSound(a, Sound.valueOf(this.\u03cd), 0.5f, 1.0f);
    ...
    private Location A(final Location location, final Vector vector) {
    ...
    public String getDisplayName() {
        return this.\u03c7.G("pedziwiatr").getString("name", "P\u0119dziwiatr");
    }
