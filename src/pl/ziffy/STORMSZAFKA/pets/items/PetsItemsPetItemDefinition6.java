...
public class PetsItemsPetItemDefinition6 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u00df;
    private PetsItemsPetItemDefinition7 \u00d9;
    private double \u00e0;
    private double \u00de;
    private double \u00dc;
    private boolean \u00d4;
    ...
    public PetsItemsPetItemDefinition6() {
        this.\u00d5 = 0.0;
        this.\u00df = false;
        ...
        this.PetsItemsPetItemDefinition7();
    }
    
    private void PetsItemsPetItemDefinition7() {
        try {
            final Map<String, Object> d = this.\u00d9.PetsItemsPetItemDefinition4("paczus");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u00d9.PetsItemsPetItemDefinition4("paczus", "hunger");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u00d9.PetsItemsPetItemDefinition4("paczus", "resistance");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u00d9.PetsItemsPetItemDefinition4("paczus", "slow");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u00d9.PetsItemsPetItemDefinition4("paczus", "regeneration");
            if (d5 != null) {
    ...
    public void spawn(final Player \u00f1, final String s) {
        ...
        String string;
        if (this.\u00d9 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u00d9.PetsItemsPetItemDefinition2("paczus", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u00d9.PetsItemsPetItemDefinition7("paczus").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTgxNzE3M2ZiMTJmMjYwZjc2NzAxNGMxMmQ4NWFhZTVlMjIyMmEwZTU0M2UzYTZmNjdkMTI0YmI1N2IzN2U2ZiJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u00d3 = (ArmorStand)\u00f1.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u00d9.PetsItemsPetItemDefinition12("paczus") + " &8\u25cf &f" + \u00f1.getName()));
            this.PetsItemsPetItemDefinition5(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u00f1.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u00d9.PetsItemsPetItemDefinition1("paczus");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u00e4 = (ArmorStand)\u00f1.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u00f1.getName()));
    ...
    public void update() {
        ...
        this.\u00d3.teleport(add);
        this.\u00e4.teleport(add.clone().add(0.0, (double)this.\u00d9.PetsItemsPetItemDefinition1("paczus").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u00d9.PetsItemsPetItemDefinition7("paczus").getString("name", "PetsItemsPetItemDefinition18\u0105czu\u015b");
    }
    ...
    private void PetsItemsPetItemDefinition5(final SkullMeta skullMeta, final String s) {
