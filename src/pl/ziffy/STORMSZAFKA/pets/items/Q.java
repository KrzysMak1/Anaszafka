...
public class Q implements D, Listener
{
    ...
    private void S() {
        try {
            final Map<String, Object> d = this.\u01bd.D("zaj\u0105czek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u01bd.D("zaj\u0105czek", "speed");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u01bd.D("zaj\u0105czek", "jump");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u01bd.D("zaj\u0105czek", "damage");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u01bd.D("zaj\u0105czek", "fall_damage");
            if (d5 != null) {
    ...
    public void spawn(final Player \u028b, final String s) {
        ...
        String string;
        if (this.\u01bd != null) {
            final Object b = this.\u01bd.B("zaj\u0105czek", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u01bd.G("zaj\u0105czek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjYxODBiYmY4YTI4MDNiNjM3YWVjMjM1NjQ1NTQ5NjJhY2JlYjkwMTBhMDBkMTM2MzYxM2FjMzk4Nzc3NDlkMyJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u01b6 = (ArmorStand)\u028b.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u01bd.L("zaj\u0105czek") + " &8\u25cf &f" + \u028b.getName()));
            this.P(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u028b.getUniqueId());
        final Map<String, Object> a = this.\u01bd.A("zaj\u0105czek");
        E.A(this.\u01c6 = (ArmorStand)\u028b.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u028b.getName()));
    ...
    public void update() {
        ...
        this.\u01b6.teleport(add);
        this.\u01c6.teleport(add.clone().add(0.0, (double)this.\u01bd.A("zaj\u0105czek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u01bd.G("zaj\u0105czek").getString("name", "Zaj\u0105czek");
    }
    ...
    private void P(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
