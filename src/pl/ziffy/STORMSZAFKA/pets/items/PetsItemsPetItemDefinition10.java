...
public class PetsItemsPetItemDefinition10 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u0136;
    private PetsItemsPetItemDefinition7 \u012e;
    ...
    public PetsItemsPetItemDefinition10() {
        this.\u012a = 0.0;
        this.\u0136 = false;
        ...
        this.PetsItemsPetItemDefinition11();
    }
    
    private void PetsItemsPetItemDefinition11() {
        try {
            final Map<String, Object> d = this.\u012e.PetsItemsPetItemDefinition4("reniferek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u012e.PetsItemsPetItemDefinition4("reniferek", "speed");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u012e.PetsItemsPetItemDefinition4("reniferek", "hunger");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u012e.PetsItemsPetItemDefinition4("reniferek", "dripstone_protection");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u012e.PetsItemsPetItemDefinition4("reniferek", "health");
            if (d5 != null) {
    ...
    public void spawn(final Player \u0127, final String s) {
        ...
        String string;
        if (this.\u012e != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u012e.PetsItemsPetItemDefinition2("reniferek", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u012e.PetsItemsPetItemDefinition7("reniferek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmI3ZjU2OTQxNTYyMTA5ZGRlNWExMzg2MGE5ODI3ZDU2YWYzOGZhYTU0NzE3MWVkMWRiZTdhNmEwNWZjOGZmMiJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u0128 = (ArmorStand)\u0127.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u012e.PetsItemsPetItemDefinition12("reniferek") + " &8\u25cf &f" + \u0127.getName()));
            this.PetsItemsPetItemDefinition9(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0127.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u012e.PetsItemsPetItemDefinition1("reniferek");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u013b = (ArmorStand)\u0127.getWorld().spawn(add.clone().add(0.0, (PetsItemsPetItemDefinition13 != null && PetsItemsPetItemDefinition13.get("height") instanceof Number) ? ((Number)PetsItemsPetItemDefinition13.get("height")).doubleValue() : 2.3, 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u0127.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u0127.getUniqueId());
        if (\u0127.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().noneMatch(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition10.\u0134))) {
            \u0127.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(PetsItemsPetItemDefinition10.\u0134, "Reniferek hearts", this.\u012c * 2.0, AttributeModifier.Operation.ADD_NUMBER));
        }
        if (this.\u0129) {
    ...
    public void update() {
        ...
        this.\u0128.teleport(add);
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u012e.PetsItemsPetItemDefinition1("reniferek");
        this.\u013b.teleport(add.clone().add(0.0, (PetsItemsPetItemDefinition13 != null && PetsItemsPetItemDefinition13.get("height") instanceof Number) ? ((Number)PetsItemsPetItemDefinition13.get("height")).doubleValue() : 2.3, 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        if (this.\u0126 != null && this.\u0126.isOnline()) {
            this.\u0126.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition10.\u0134)).findFirst().ifPresent(attributeModifier2 -> this.\u0126.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
    ...
    public String getDisplayName() {
        return this.\u012e.PetsItemsPetItemDefinition7("reniferek").getString("name", "Reniferek");
    }
    ...
    private void PetsItemsPetItemDefinition9(final SkullMeta skullMeta, final String s) {
