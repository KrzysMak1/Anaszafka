...
public class PetsItemsPetItemDefinition21 implements PetsItemsPetItemDefinition4, Listener
{
    ...
    private boolean \u01f0;
    private Random \u01df;
    private PetsItemsPetItemDefinition7 \u01e9;
    ...
    public PetsItemsPetItemDefinition21() {
        this.\u01e7 = 0.0;
        this.\u01f0 = false;
        this.\u01df = new Random();
        ...
        this.PetsItemsPetItemDefinition23();
    }
    
    private void PetsItemsPetItemDefinition23() {
        try {
            final Map<String, Object> d = this.\u01e9.PetsItemsPetItemDefinition4("pisklak");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u01e9.PetsItemsPetItemDefinition4("pisklak", "health");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u01e9.PetsItemsPetItemDefinition4("pisklak", "defense");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u01e9.PetsItemsPetItemDefinition4("pisklak", "drop");
            if (d4 != null) {
    ...
    public void spawn(final Player \u01e1, final String s) {
        ...
        String string;
        if (this.\u01e9 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u01e9.PetsItemsPetItemDefinition2("pisklak", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u01e9.PetsItemsPetItemDefinition7("pisklak").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzkzMjkyMGY4MWI2YzU2ZmVkNmNkNWUwNzc3MmZkNTQwMjQ2NTgyMjkyYjU2YzAzNDViZWIzMGQwMzNkNmVhYiJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u01e6 = (ArmorStand)\u01e1.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u01e9.PetsItemsPetItemDefinition12("pisklak") + " &8\u25cf &f" + \u01e1.getName()));
            this.PetsItemsPetItemDefinition20(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u01e1.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u01e9.PetsItemsPetItemDefinition1("pisklak");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u01f4 = (ArmorStand)\u01e1.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u01e1.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u01e1.getUniqueId());
        \u01e1.setFoodLevel(20);
        \u01e1.setSaturation(20.0f);
        if (\u01e1.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().noneMatch(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition21.\u01ee))) {
            \u01e1.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(PetsItemsPetItemDefinition21.\u01ee, "Pisklak hearts", (double)this.\u01e3, AttributeModifier.Operation.ADD_NUMBER));
        }
    }
    ...
    public void update() {
        ...
        this.\u01e6.teleport(add);
        this.\u01f4.teleport(add.clone().add(0.0, (double)this.\u01e9.PetsItemsPetItemDefinition1("pisklak").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        if (this.\u01e0 != null && this.\u01e0.isOnline()) {
            this.\u01e0.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition21.\u01ee)).findFirst().ifPresent(attributeModifier2 -> this.\u01e0.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
        }
    }
    
    @Override
    public String getDisplayName() {
        return this.\u01e9.PetsItemsPetItemDefinition7("pisklak").getString("name", "Pisklak");
    }
    ...
    public void onBlockBreak(final BlockBreakEvent blockBreakEvent2) {
        ...
        if (PetsItemsPetItemDefinition21.\u01ea.contains(type) || PetsItemsPetItemDefinition21.\u01ed.contains(type)) {
    ...
    private void PetsItemsPetItemDefinition20(final SkullMeta skullMeta, final String s) {
