...
public class PetsItemsPetItemDefinition24 implements PetsItemsPetItemDefinition4
{
    ...
    private boolean \u038e;
    private PetsItemsPetItemDefinition7 \u02d1;
    private double \u02e2;
    private double \u02e3;
    private double \u02c1;
    private double \u02e1;
    ...
    public PetsItemsPetItemDefinition24() {
        this.\u02e0 = 0.0;
        this.\u038e = false;
    ...
    private void d() {
        final Map<String, Object> d = this.\u02d1.PetsItemsPetItemDefinition4("aniolek");
        this.\u02e3 = (double)d.get("height");
        this.\u02e2 = (double)d.get("speed");
        this.\u02c1 = (double)d.get("distance");
        final Map<String, Object> d2 = this.\u02d1.PetsItemsPetItemDefinition4("aniolek", "health");
    ...
    public void spawn(final Player \u02d0, final String s) {
        ...
        String string;
        if (this.\u02d1 != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u02d1.PetsItemsPetItemDefinition2("aniolek", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s3) {
                string = s3;
            }
            else {
                final Object b2 = this.\u02d1.PetsItemsPetItemDefinition2("aniolek", "texture");
                if (b2 instanceof final String s2) {
                    string = s2;
                }
                else {
                    string = this.\u02d1.PetsItemsPetItemDefinition7("aniolek").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjQyODA3Mjk2YjQxOWFmMDYxZjJmOWQzNmRkMTlhODhiZjc1NGQyYWJjODVmNzMxZDQ1ZjJlN2JiYzkyOTk5ZCJ9fX0=");
                }
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u0389 = (ArmorStand)\u02d0.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u02d1.PetsItemsPetItemDefinition12("aniolek") + " &8\u25cf &f" + \u02d0.getName()));
            this.PetsItemsPetItemDefinition29(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u02d0.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u02d1.PetsItemsPetItemDefinition1("aniolek");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u038c = (ArmorStand)\u02d0.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u02d0.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u02d0.getUniqueId());
        try {
            \u02d0.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition24.\u037a)).forEach(attributeModifier2 -> player.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
            \u02d0.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(PetsItemsPetItemDefinition24.\u037a, "aniolek_health_bonus", this.\u02e1, AttributeModifier.Operation.ADD_NUMBER));
    ...
    public void update() {
        ...
        this.\u0389.teleport(add);
        this.\u038c.teleport(add.clone().add(0.0, (double)this.\u02d1.PetsItemsPetItemDefinition1("aniolek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        try {
            if (this.\u02d0 != null && this.\u02d0.isOnline()) {
                this.\u02d0.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(PetsItemsPetItemDefinition24.\u037a)).forEach(attributeModifier2 -> this.\u02d0.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
    ...
    public String getDisplayName() {
        return this.\u02d1.PetsItemsPetItemDefinition7("aniolek").getString("name", "Anio\u0142ek");
    }
    
    private void PetsItemsPetItemDefinition29(final SkullMeta skullMeta, final String s) {
