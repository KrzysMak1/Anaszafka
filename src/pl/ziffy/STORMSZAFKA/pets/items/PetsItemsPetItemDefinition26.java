...
public class PetsItemsPetItemDefinition26 implements PetsItemsPetItemDefinition4
{
    ...
    private boolean \u0278;
    private PetsItemsPetItemDefinition7 \u026d;
    private double \u026f;
    private double \u0270;
    private double \u026a;
    private double \u026b;
    ...
    public PetsItemsPetItemDefinition26() {
        this.\u026e = 0.0;
        this.\u0278 = false;
        this.\u026d = Main.getPetConfigManager();
        this.PetsItemsPetItemDefinition29();
    }
    
    private void PetsItemsPetItemDefinition29() {
        try {
            final Map<String, Object> d = this.\u026d.PetsItemsPetItemDefinition4("leniuszek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u026d.PetsItemsPetItemDefinition4("leniuszek", "afk_drop_multiplier");
            if (d2 != null) {
    ...
    public void spawn(final Player \u026c, final String s) {
        ...
        String string;
        if (this.\u026d != null) {
            final Object PetsItemsPetItemDefinition14 = this.\u026d.PetsItemsPetItemDefinition2("leniuszek", "item.texture.value");
            if (PetsItemsPetItemDefinition14 instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u026d.PetsItemsPetItemDefinition7("leniuszek").getString("texture.value", "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmIwZmQwODM4ZDY4NmY2NGQwNDdiYmVjNzY5NWY3YzhjNjJlMmI1OTQ4OTg2ZjJmYzM3NGE5YjU1NGZiNDRkOCJ9fX0=");
            }
        }
        else {
        ...
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition2(this.\u0275 = (ArmorStand)\u026c.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(this.\u026d.PetsItemsPetItemDefinition12("leniuszek") + " &8\u25cf &f" + \u026c.getName()));
            this.PetsItemsPetItemDefinition25(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u026c.getUniqueId());
        final Map<String, Object> PetsItemsPetItemDefinition13 = this.\u026d.PetsItemsPetItemDefinition1("leniuszek");
        PetsItemsPetItemDefinition5.PetsItemsPetItemDefinition1(this.\u0277 = (ArmorStand)\u026c.getWorld().spawn(add.clone().add(0.0, (double)PetsItemsPetItemDefinition13.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(PetsItemsPetItemDefinition7.PetsItemsPetItemDefinition3(s + " &8\u25cf &f" + \u026c.getName()));
    ...
    public void update() {
        ...
        this.\u0275.teleport(add);
        this.\u0277.teleport(add.clone().add(0.0, (double)this.\u026d.PetsItemsPetItemDefinition1("leniuszek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u026d.PetsItemsPetItemDefinition7("leniuszek").getString("name", "Leniuszek");
    }
    
    public double PetsItemsPetItemDefinition28() {
        return this.\u026b;
    }
    
    public boolean PetsItemsPetItemDefinition24() {
        return this.\u0272;
    }
    
    private void PetsItemsPetItemDefinition25(final SkullMeta skullMeta, final String s) {
