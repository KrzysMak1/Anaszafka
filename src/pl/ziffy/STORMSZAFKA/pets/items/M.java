...
public class M implements D, Listener
{
    ...
    private void O() {
        try {
            final Map<String, Object> d = this.\u0171.D("pierniczek");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u0171.D("pierniczek", "health");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u0171.D("pierniczek", "speed");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u0171.D("pierniczek", "ore_duplication");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u0171.D("pierniczek", "crop_duplication");
            if (d5 != null) {
            ...
            final Map<String, Object> d6 = this.\u0171.D("pierniczek", "stone_xp");
            if (d6 != null) {
    ...
    public void spawn(final Player \u0167, final String s) {
        ...
        String string;
        if (this.\u0171 != null) {
            final Object b = this.\u0171.B("pierniczek", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0171.G("pierniczek").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWU2MzQ5MTJjNTI5NTNmMDMzZmExMTY2ODg2NjljOWE2ZDRkNTdkMzI1NjI5MTdiNTdkYTU4MzgwMmQ5ZjJlZSJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u016b = (ArmorStand)\u0167.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u0171.L("pierniczek") + " &8\u25cf &f" + \u0167.getName()));
            this.L(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u0167.getUniqueId());
        final Map<String, Object> a = this.\u0171.A("pierniczek");
        E.A(this.\u017f = (ArmorStand)\u0167.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u0167.getName()));
            armorStand.setCustomNameVisible(true);
        }), \u0167.getUniqueId());
        if (this.\u0169 > 0.0 && \u0167.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().noneMatch(attributeModifier -> attributeModifier.getUniqueId().equals(M.\u017a))) {
            \u0167.getAttribute(Attribute.GENERIC_MAX_HEALTH).addModifier(new AttributeModifier(M.\u017a, "Pierniczek hearts", this.\u0169, AttributeModifier.Operation.ADD_NUMBER));
        }
        if (this.\u016e > 0) {
    ...
    public void update() {
        ...
        this.\u016b.teleport(add);
        this.\u017f.teleport(add.clone().add(0.0, (double)this.\u0171.A("pierniczek").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public void remove() {
        ...
        if (this.\u0167 != null && this.\u0167.isOnline()) {
            this.\u0167.getAttribute(Attribute.GENERIC_MAX_HEALTH).getModifiers().stream().filter(attributeModifier -> attributeModifier.getUniqueId().equals(M.\u017a)).findFirst().ifPresent(attributeModifier2 -> this.\u0167.getAttribute(Attribute.GENERIC_MAX_HEALTH).removeModifier(attributeModifier2));
            if (this.\u016e > 0) {
    ...
    public String getDisplayName() {
        return this.\u0171.G("pierniczek").getString("name", "Pierniczek");
    }
    ...
    public void onBlockBreak(final BlockBreakEvent blockBreakEvent2) {
        ...
        if ((M.\u0172.contains(type) && this.\u0166.nextDouble() < this.\u016f) || (M.\u0179.contains(type) && this.\u0166.nextDouble() < this.\u0173)) {
    ...
    private void L(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
