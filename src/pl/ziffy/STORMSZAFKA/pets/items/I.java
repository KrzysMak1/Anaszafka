...
public class I implements D, Listener
{
    ...
    private void J() {
        try {
            final Map<String, Object> d = this.\u0119.D("sowa");
            if (d != null) {
            ...
            final Map<String, Object> d2 = this.\u0119.D("sowa", "damage");
            if (d2 != null) {
            ...
            final Map<String, Object> d3 = this.\u0119.D("sowa", "hunger");
            if (d3 != null) {
            ...
            final Map<String, Object> d4 = this.\u0119.D("sowa", "health_view");
            if (d4 != null) {
            ...
            final Map<String, Object> d5 = this.\u0119.D("sowa", "speed");
            if (d5 != null) {
    ...
    public void spawn(final Player \u010f, final String s) {
        ...
        String string;
        if (this.\u0119 != null) {
            final Object b = this.\u0119.B("sowa", "item.texture.value");
            if (b instanceof final String s2) {
                string = s2;
            }
            else {
                string = this.\u0119.G("sowa").getString("texture.value", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTg2OWY2Nzk2MWYzZWU1YjY4ZTM4Zjc5ODU3MDY4ZWQxNmNiZGYwZjhjOWNlYTJkNzUwNGZjOGRmODcxZDFkNyJ9fX0=");
            }
        }
        else {
        ...
        E.B(this.\u0111 = (ArmorStand)\u010f.getWorld().spawn(add, (Class)ArmorStand.class, armorStand -> {
            ...
            itemMeta.setDisplayName(G.C(this.\u0119.L("sowa") + " &8\u25cf &f" + \u010f.getName()));
            this.H(itemMeta, string);
            helmet.setItemMeta((ItemMeta)itemMeta);
            armorStand.setHelmet(helmet);
        }), \u010f.getUniqueId());
        final Map<String, Object> a = this.\u0119.A("sowa");
        E.A(this.\u0124 = (ArmorStand)\u010f.getWorld().spawn(add.clone().add(0.0, (double)a.get("height"), 0.0), (Class)ArmorStand.class, armorStand -> {
            armorStand.setVisible(false);
            armorStand.setGravity(false);
            armorStand.setMarker(true);
            armorStand.setCustomName(G.C(s + " &8\u25cf &f" + \u010f.getName()));
    ...
    public void update() {
        ...
        this.\u0111.teleport(add);
        this.\u0124.teleport(add.clone().add(0.0, (double)this.\u0119.A("sowa").get("height"), 0.0));
        if (hasPotionEffect) {
    ...
    public String getDisplayName() {
        return this.\u0119.G("sowa").getString("name", "Sowa");
    }
    ...
    public void onEntityDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        if (this.\u010e != null && entityDamageByEntityEvent.getDamager() instanceof Player && this.\u011d && ((Player)entityDamageByEntityEvent.getDamager()).getUniqueId().equals(this.\u010e.getUniqueId())) {
            ...
            if (this.\u0117 && entityDamageByEntityEvent.getEntity() instanceof Player) {
                this.H((Player)entityDamageByEntityEvent.getEntity());
            }
        }
    }
    
    private void H(final Player player) {
        if (this.\u011b.containsKey(player.getUniqueId())) {
            this.\u011b.get(player.getUniqueId()).cancel();
        }
        this.\u011b.put(player.getUniqueId(), Bukkit.getScheduler().runTaskTimer(Bukkit.getPluginManager().getPlugin("STORMSZAFKA"), () -> this.E(player2), 0L, 20L));
    ...
    private void H(final SkullMeta skullMeta, final String s) {
        C.D(skullMeta, s);
    }
